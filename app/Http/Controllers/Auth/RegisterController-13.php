    ...
    */
		...
		/* echo "aaaa";die;
		 ...
		 if($data['role']=='school'){
		    ...
		    [   'name.required' =>'Your Name/School Name/Organisation Name field is required.',			
				...
				'mobile.digits' =>'Mobile field must have 10 digit.',
    			'password.required'=>'Password is required.',
    			'password.min'=>'Please enter 8 digit value.',
    			'password.confirmed'=>'Password must equal to confirm password.',
    ...
    {  
        ...
        if($user->id){
			...
			if(!empty($data['mobile'])) $usermeta->mobile = $data['mobile'];

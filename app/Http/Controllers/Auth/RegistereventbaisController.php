...
class RegistereventbaisController extends Controller
{
	/*
    |--------------------------------------------------------------------------
    | Register Controller
    ...
    */
	...
	public function showRegistrationForm(Request $request)
	{
		...
		if($role_name == 'bmFtby1maXQtaW5kaWEteW91dGgtY2x1Yg=='){
			...
			return view('auth.coiregistration', compact('roles', 'state', 'districts', 'blocks'));
			...
			return view('auth.coiregistration', compact('roles', 'state', 'districts', 'blocks','participant'));
	...
	public function coiregistration(Request $request){
		try{
			...
			// return view('auth.cyclothonregister', compact('roles', 'state', 'districts', 'blocks'));
			return view('auth.coiregistration', compact('roles', 'state'));
    ...
    public function coiregistrationdrive(Request $request){
        ...
        try{
			...
			// return view('auth.cyclothonregister', compact('roles', 'state', 'districts', 'blocks'));
			return view('auth.coiregistrationdrive', compact('roles', 'state'));
	...
	public function getBlock(Request $request)
	{
        ...
        public function saveregisterdrive(Request $request){
            // dd($request->all());
            ...
            $success = "Successfully Inserted Record";
            $request->session()->put('succ', $success);
           return redirect()->route('coiregistrationdrive')->withSuccess('Success message');;
        }
}

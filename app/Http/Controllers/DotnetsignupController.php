        ...
        try {
            ...
            if ($apitoken == $dot_net_apitoken) {
                ...
                foreach ($data as $x => $val) {
                    ...
                    $query = "SELECT * FROM `usermetas` where user_id = $KheloIndiaId;";

                    $data = DB::select(DB::raw($query));
                    
                    // date formet not recived from api, that why change code
                    // if (isset($data[0]->dob)) {
                    ...
                    if (!empty($data[0]->dob)) {
                        ...
                        $date = str_replace('/', '-', $dob_sql);
                        $dob = date('Y-m-d', strtotime($date));
                        // $timestamp = strtotime($dob_sql);
                        // echo $timestamp;
                    ...
                    // dd($conn);
                    // echo "EXEC spFITIndiaSignUp $KheloIndiaId," . "'$UserName'" . "," . "'$name'" . "," . "'$MobileNo'" . "," . "'$EmailID'" . "," . "'$Gender'" . "," . "'$DOB'" . "," . "'$QueryType'" . "," . "'$AddressLine1'" . "," . "'$AddressLine2'" . "," . "'$District'" . "," . "'$State'" . "," . "'$PinCode'" . "," . "'$UIDNo'" . "," . "'$Block'" . "," . "'$Age'" . "," . "'$Role'" . "," . "'$PhotoName'" . "," . "'$Weight'" . "," . "'$Height '" . "," . "'$Distance '" . "," . "'$ScoreUint'";

...
class CsveventController extends Controller
{
    ...
    function socEventReport13072025(){
        ...
        $data = DB::select(DB::raw($query));
            ...
            fclose($handle);
            return Response::download($filename, "Cycle-Booking.csv", $headers);
    }
    ...
    function soc_report_both_data(){
        ...
        $query = "SELECT users.email,users.phone,usermetas.address_line_one,usermetas.address_line_two,sopr.user_id,sopr.uname,sopr.event_date,sopr.cycle,sopr.meal FROM soc_event_participation_receives as sopr INNER join users on users.id = sopr.user_id join usermetas on users.id = usermetas.user_id where sopr.socemid = 9 and sopr.user_id in (select user_id from soc_event_participations where socemid = 9);";
        ...
        $data = DB::select(DB::raw($query));
            ...
            fclose($handle);
            return Response::download($filename, "Cycle-Allotted.csv", $headers);
    }
    ...
    function socEventReportdata13072025(){
        ...
        // $query = "SELECT sopr.user_id,sopr.uname,sopr.event_date,sopr.cycle,sopr.meal FROM soc_event_participation_receives as sopr where sopr.socemid = 3 and sopr.user_id not in (select user_id from soc_event_participations where socemid = 3);";
        $query = "SELECT users.email,users.phone,usermetas.address_line_one,usermetas.address_line_two,sopr.user_id,sopr.uname,sopr.event_date,sopr.cycle,sopr.meal FROM soc_event_participation_receives as sopr INNER join users on users.id = sopr.user_id join usermetas on users.id = usermetas.user_id where sopr.socemid = 9 and sopr.user_id not in (select user_id from soc_event_participations where socemid = 9);";
    ...
    function soc_report_cycle_return_data(){
        ...
        $query = "SELECT users.email,
                    ...
                    where sopr.socemid = 9 and sopr.user_id;";
        ...
        $data = DB::select(DB::raw($query));
            ...
            fclose($handle);
            return Response::download($filename, "Cycle-Returned.csv", $headers);
    }

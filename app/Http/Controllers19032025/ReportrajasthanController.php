...
{    
    ...
    public function event_get_csv_participant_count(){ 
        try{
            ...
            $query = "SELECT count(1) as count FROM users as u inner JOIN usermetas as um on um.user_id = u.id where u.created_at > '2024-08-14 00:00:01' and um.state = 'rajasthan';";

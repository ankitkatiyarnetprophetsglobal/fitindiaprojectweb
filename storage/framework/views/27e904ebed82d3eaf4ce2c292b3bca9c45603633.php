            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <img id="preview-image"
                        src="<?php echo e($banner && $banner->banner_url ? $banner->banner_url : '#'); ?>"
                        alt="Preview will appear here"
                        style="max-width: 100%; max-height: 300px; <?php echo e($banner && $banner->banner_url ? '' : 'display:none;'); ?>"
...
<?php /**PATH C:\xampp\htdocs\fitindiaweb_gitnew\resources\views/admin/generalevent/index.blade.php ENDPATH**/ ?>
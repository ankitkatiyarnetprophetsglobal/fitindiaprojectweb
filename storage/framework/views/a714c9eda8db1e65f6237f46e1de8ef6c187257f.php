...
<script type="text/javascript">
	$('#youth_state').change(function(){				
		...
		$.ajax({
			url: "<?php echo e(route('getyouthsdistrict')); ?>",
			type: "post",
			data: { "id":statename,"stname":state_id,"_token": "<?php echo e(csrf_token()); ?>"} ,
	...
	$('#youth_district').change(function(){		
		...
		$.ajax({
			url: "<?php echo e(route('getyouthsblock')); ?>",
			type: "post",
			data: { "id":distname,"distname":dist_id,"_token": "<?php echo e(csrf_token()); ?>"} ,
			success: function (response) {
			    //alert(response);	
			   console.log(response);
...
</script>  <?php /**PATH C:\xampp\htdocs\fitindiaweb_gitnew\resources\views/admin/layouts/footer.blade.php ENDPATH**/ ?>
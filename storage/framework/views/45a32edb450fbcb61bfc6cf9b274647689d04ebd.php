<?php $__env->startSection('title', 'Register | Fit India'); ?>
<?php $__env->startSection('content'); ?>

<link href="<?php echo e(asset('resources/css/select2/select2.min.css')); ?>" rel="stylesheet" media="all">
<style>
    .register-row-lft{
        width: 64% !important;
    }
...
<section class="log_sec">
    ...
    <div class="container">
        <div id="divloader" class="loaderregister" style="display: none">
            ...
            <img style="margin-top:15%; width: 15%; height: 25%;" src="<?php echo e(url('/wp-content/uploads/2021/01/loader.gif')); ?>" />
        </div>
        <div class="row">
            <div class="col-12 signup_frm">
                <div class="">
                    <form id="fi-register" class="register-form" action="<?php echo e(route('register')); ?>" method="post" novalidate="novalidate">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="frm-details res_mobile">
                            ...
                            <label for="role"><?php echo e(__('Register As')); ?></label>
                            <div class="register-row">
                                <div class="register-row-lft">
                                    ...
                                    <?php if(isset($_GET['role'])): ?>
                                        ...
                                        <?php if($_GET['role'] == 'bmFtby1maXQtaW5kaWEtY3ljbGluZy1jbHVi' || $_GET['role'] == 'bmFtby1maXQtaW5kaWEteW91dGgtY2x1Yg=='): ?>
                                            <select class="form-control cyclothonrolew <?php $__errorArgs = ['cyclothonrole'];
...
unset($__errorArgs, $__bag); ?>" name="cyclothonrole" id="cyclothonrole" required autocomplete="cyclothonrole" autofocus>
                                                <option value="club" selected>Club</option>
                                            </select>
                                        <?php endif; ?>
                                        <?php $__errorArgs = ['cyclothonrole'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <input type="hidden" name="role_name" id="role_name" value="<?php echo e($_GET['role'] ?? ''); ?>">
...
unset($__errorArgs, $__bag); ?>" name="role" id="role" required autocomplete="role" autofocus>
                                        <?php if(isset($_GET['role'])): ?>
                                            <?php if($_GET['role'] != 'bmFtby1maXQtaW5kaWEtY3ljbGluZy1jbHVi'): ?>
                                        ...
                                        <option <?php if(isset($_GET['role'])){ if(base64_decode($_GET['role']) ==  $role->slug){ echo "selected='selected'";}} ?> value="<?php echo e($role->slug); ?>"  <?php if(old('role') == $role->slug): ?> <?php echo e('selected'); ?> <?php endif; ?> ><?php echo e(Str::upper($role->name)); ?></option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div style="clear:both"></div>
                                <?php if(isset($role_name)): ?>
                                    <?php if($role_name == 'cyclothon-2024'): ?>
                                        ...
                                        <div class="register-row my-search-select-cls" id="user_join_club_id_show" style="display:block;">
                                            ...
                                            <div class="register-row" >
                                                <div class="register-row-lft">
                                                    ...
                                                    <select class="form-control <?php $__errorArgs = ['user_join_club_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> select2"  name="user_join_club_id" id="user_join_club_id" required autocomplete="user_join_club_id" autofocus>
                                                        <option value="">Do you belong to any of the NAMO cycling Clubs?</option>
                                                        <?php if(isset($club_name_with_id)): ?>
                                                            <?php if(count($club_name_with_id) > 0): ?>
                                                                <?php $__currentLoopData = $club_name_with_id; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div id="udise_row" style="display:none;">
                                                    <input id="fi_udise" type="text" class="form-control <?php $__errorArgs = ['udise'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="udise" value="<?php echo e(old('udise')); ?>" required autocomplete="U-Dise Number" placeholder="U-Dise Number">
                                                    <?php $__errorArgs = ['udise'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus placeholder="<?php echo e($club_name ?? 'Name'); ?>">
                                    ...
                                    <div class="register-row-rt">
                                        <?php if(isset($_GET['role'])): ?>
                                            <?php if($_GET['role'] == 'bmFtby1maXQtaW5kaWEtY3ljbGluZy1jbHVi' || $_GET['role'] == 'bmFtby1maXQtaW5kaWEteW91dGgtY2x1Yg=='): ?>
                                                ...
                                                <input id="participant_number" type="number" class="form-control <?php $__errorArgs = ['participant_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="participant_number" value="<?php echo e(old('participant_number')); ?>" required autocomplete="Participant Number" placeholder="<?php echo e($participant ?? 'Participant Number'); ?>" min="0">
                                                <?php $__errorArgs = ['participant_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" name="participant_number" value="<?php echo e(old('participant_number')); ?>" required autocomplete="Participant Number" placeholder="Participant Number" min="0">
                                                <?php $__errorArgs = ['participant_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="off" placeholder="Email">
...
unset($__errorArgs, $__bag); ?>" name="phone" value="<?php echo e(old('phone') ?? ""); ?>" required autocomplete="phone" min="0" max="9999999999" placeholder="Mobile">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php if(isset($_GET['role'])): ?>
                                    <?php if($_GET['role'] == 'bmFtby1maXQtaW5kaWEtY3ljbGluZy1jbHVi' || $_GET['role'] == 'bmFtby1maXQtaW5kaWEteW91dGgtY2x1Yg=='): ?>
                                        <div id="udisenumrow" class="register-row">
                                            <div class="register-row-lft">
                                            <input id="address_line_one" type="text" class="form-control <?php $__errorArgs = ['address_line_one'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="address_line_one" value="<?php echo e(old('address_line_one')); ?>" required autocomplete="address_line_one" autofocus placeholder="Address Line 1">
                                                <?php $__errorArgs = ['address_line_one'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="register-row-rt">
                                                        <input id="address_line_two" type="text" class="form-control <?php $__errorArgs = ['address_line_two'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="address_line_two" value="<?php echo e(old('address_line_two')); ?>" required autocomplete="address_line_two" placeholder="Address Line 2">
                                                        <?php $__errorArgs = ['address_line_two'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="register-row e-mob-fx" >
                                    <div class="register-row-lft">
                                        <input id="pincode" type="number" class="form-control <?php $__errorArgs = ['pincode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> pincode_value" name="pincode" value="<?php echo e(old('phone') ?? ""); ?>" required autocomplete="pincode" min="0" max="999999" placeholder="Pin Code">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="register-row-rt" id="tshirtsizeshow" style="display: none">
                                                <select id="tshirtsize" name="tshirtsize" class="form-control <?php $__errorArgs = ['tshirtsize'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" aria-required="true" >
...
unset($__errorArgs, $__bag); ?> select2" aria-required="true">
                                            <option value="">Select State</option>
                                            <?php $__currentLoopData = $state->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($st->name): ?>
                                                    <option value="<?php echo e($st->id); ?>"  <?php if(!empty(old('state')) && old('state') == $st->id): ?> <?php echo e('selected'); ?> <?php endif; ?> >
                                                        <?php echo e($st->name); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div style="clear:both"></div>
                                    <div class="register-row-rt">
                                        <select id="district" name="district" class="form-control <?php $__errorArgs = ['district'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" aria-required="true">
                                            ...
                                            if(!empty($districts)){
                                            ?>
                                                <?php $__currentLoopData = $districts->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($st->name): ?>
                                                <option value="<?php echo e($st->id); ?>"  <?php if(!empty(old('district')) && old('district') == $st->id): ?> <?php echo e('selected'); ?> <?php endif; ?> >
                                                <?php echo e($st->name); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="register-row">
                                    <div class="register-row-lft">
                                        <select id="block" name="block" class="form-control <?php $__errorArgs = ['block'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" aria-required="true">
                                            ...
                                            <?php
                                                if(!empty($districts)){
                                            ?>
                                                <?php $__currentLoopData = $blocks->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($st->name): ?>
                                                    <option value="<?php echo e($st->id); ?>"  <?php if(!empty(old('block')) && old('block') == $st->id): ?> <?php echo e('selected'); ?> <?php endif; ?> >
                                                    <?php echo e(ucwords(strtolower($st->name))); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="register-row-rt">
                                        ...
                                        <div id="city_show_hide" style="display:block;">
                                            <input id="fi_city" type="text" class="form-control required  <?php $__errorArgs = ['city'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="city" value="<?php echo e(old('city')); ?>" placeholder="City/Town/Village" aria-required="true" onkeydown="return /[a-z, ]/i.test(event.key)"
...
unset($__errorArgs, $__bag); ?>"
                                        name="password" value="<?php echo e(old('password')); ?>" required autocomplete="new-password" placeholder="Password">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('password_confirmation')); ?>" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm Password">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div id="cycle_display" style="display:block;">
                                    <div class="register-row">
                                        <div class="register-row-lft r_parent">
                                            <select id="cycle" name="cycle" class="form-control <?php $__errorArgs = ['block'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<script src="<?php echo e(asset('resources/pincode/select2.min.js')); ?>"></script>
...
<script type="text/javascript">
    ...
    $('#state').change(function(){
        state_id = $('#state').val();
        $.ajax({
            url: "<?php echo e(route('getdistrict')); ?>",
            type: "post",
            data: { "id":state_id,"_token": "<?php echo e(csrf_token()); ?>"} ,
    ...
    $('#district').change(function(){
        ...
        $.ajax({
            url: "<?php echo e(route('getblock')); ?>",
            type: "post",
            data: { "id":dist_id,"_token": "<?php echo e(csrf_token()); ?>"} ,
            success: function (response) {
                //console.log(response);
                $('#block').html(response);
            },
    ...
    function fi_rolechange(val){
	   $.ajax({
           ...
           type: "post",
           data: { "groupid" : val, "_token": "<?php echo e(csrf_token()); ?>"} ,
           success: function (response) {
               //console.log(response);
    ...
    //        url: "<?php echo e(route('duplicateemailcheck')); ?>",
    //        type: "post",
    //        data: {
    //                 "email":email_value,
    //                 "role_name":role_name,
    ...
    $('.mobile_verify').click(function(){
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('duplicatemobilecheck')); ?>",
            type: "post",
            data: {
    ...
    $('#email_otp_verify').click(function(){
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('emailotpcheck')); ?>",
            type: "post",
            data: {
                    "otp_value":otp_value,
                    "email":email_value,
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(response[0].Status == 'Success'){
                        ...
                        // html3 += `<select id="fi_city" name="city" class="form-control <?php $__errorArgs = ['fi_city'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" aria-required="true">`;
                        ...
                        // // }
                        // html3 += `</select>`;
                        // html3 = `<input id="fi_city" type="text" class="form-control required  <?php $__errorArgs = ['city'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="city" value="<?php echo e(old('city')); ?>" placeholder="City/Town/Village" aria-required="true" onkeydown="return /[a-z, ]/i.test(event.key)"`;
    ...
    $('#mobile_otp_verify').click(function(){
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('mobileotpcheck')); ?>",
            type: "post",
            data: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fitindiaweb_gitnew\resources\views/auth/coiregistration.blade.php ENDPATH**/ ?>
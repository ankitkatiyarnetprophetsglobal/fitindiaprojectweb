<?php $__env->startSection('title', 'Fit India School Registration| Fit India'); ?>
        ...
        function chkorganise(){
            ...
            if (agree.checked == false){
              ...
              return false;
				   ...
				   window.location.href = "<?php echo e(url('/fit-india-school-certification')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fitindiaweb_gitnew\resources\views/fit-india-school-registration.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Fit India - Be fit '); ?>
...
<!-- <script src="<?php echo e(asset('resources/js/jquery.bootstrap.newsbox.js')); ?>"></script>
 --><!-- <script src="<?php echo e(asset('resources/js/jquery.waypoints.min.js')); ?>"></script>
<script src="<?php echo e(asset('resources/js/jquery.counterup.min.js')); ?>"></script> -->
<!-- <script>
...
<div class="container-fluid">
            ...
            <div class="col-12">
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <?php if(count($websitebanner) > 0): ?>
                            <?php $__currentLoopData = $websitebanner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                
                                <div class="<?php echo e($banner['active_css']); ?>">
                                    <a href="<?php echo e($banner['landing_url']); ?>">
                                        <img src="<?php echo e($banner['banner_url']); ?>" class="d-block w-100" alt="<?php echo e($banner['name']); ?>" title="<?php echo e($banner['name']); ?>">
                                    </a>
                                </div>
    ...
    <section id="<?php echo e($active_section_id); ?>">
        <div class="container">
            ...
            <div class="row r-m">
                <div class="col-sm-12 col-md-12 col-lg-12">
                <h1 class="a_heading about_head headH1"><?php echo e(__('home_content.About_Fit_India_Movement')); ?> <!--About Fit India Movement--></h1>
                    <p class="text-justify ab_para"> <span class="logo-fitindia"> <img
                                src="<?php echo e(asset('resources/imgs/fit-india_logo.png')); ?>" alt="Fit India logo"
                                title="Fit India" class="img-fluid"></span> <?php echo e(__('home_content.Fit_India_Movement')); ?> <!--FIT INDIA Movement was launched on 29th August,
                    ...
                    <ul class="aboutLi">
                        <li><?php echo e(__('home_content.Promote_Fitness')); ?> <!--To promote fitness as easy, fun and free --></li>
                        <li><?php echo e(__('home_content.Tospread_Awareness')); ?> <!--To spread awareness on fitness and various physical activities that promote fitness through
                            focused campaigns--></li>
                        <li><?php echo e(__('home_content.Toencourage')); ?> <!--To encourage indigenous sports--></li>
                        <li><?php echo e(__('home_content.Tomake_Fitness')); ?> <!--To make fitness reach every school, college/university, panchayat/village, etc.--></li>
                        <li><?php echo e(__('home_content.Tocreate_Platform')); ?> <!--To create a platform for citizens of India to share information, drive awareness and
                ...
                <!-- <a  class="getlink" href="javascript:void(0);" data-link="https://drive.google.com/drive/u/0/folders/13RmlJ0dqhc6ZtnNiLKL9zq1hLoYy5mbv">
                 <div class="card" style="padding:5px;"><img src="<?php echo e(asset('resources/imgs/home/olympic.jpeg')); ?>" class="img-fluid"  alt="opymics ki aasha"   title="opymics ki aasha"/>
                </div>
                </a> -->
        ...
        <!----------------------- new ticker ----------------------------------->
            ...
            <!-- <div class="mt-4">
                <div class="count_div_h" style="background-color:#fff3e6">
                    <h1 class=" free_head"><?php echo e(__('home_content.Freedomrun')); ?></h1>
                    <div class="d-flex justify-content-between pad_div_counter">
                        <div class="counter_area text-center ">
                            <span class="" style="display: inline-block; "><?php echo e($pnt_total); ?> </span>
                            <span style="display:block;font-size:16px;"><?php echo e(__('home_content.Totalparticipants')); ?> </span>
                        </div>
                        <div class="counter_area text-center border-right_1"></div>
                        <div class="counter_area text-center">
                            <span class="" style="display: inline-block; "><?php echo e($kms_total); ?></span>
                            <span style="display:block;font-size:16px;"><?php echo e(__('home_content.Totalkmscov')); ?> </span>
                        </div>
                    </div>
                     <a id="invidual_download" class="btn btn-primary btn-sm clic_btn mt-4" href="freedom-run-dashboard" style="padding: 5px 40px;"><?php echo e(__('home_content.livedashboard')); ?></a>
                </div>
            </div>  -->
            
         <div class="row align-items-start mt-3">
                <div class="col-lg-4 col-md-6 col-12">
                   <a href="<?php echo e(url('event-archives')); ?>" class="evnt-archv"><h4>Events Archive</h4>
                <div id="m_slider">
                    <img class="m_Slides"  src="<?php echo e(asset('resources/imgs/event_home/img_1.jpg')); ?>" width="100%"  alt="Pahari Dance">
                    <img class="m_Slides"  src="<?php echo e(asset('resources/imgs/event_home/img_2.jpg')); ?>" width="100%" alt="Panjabi Dance">
                    <img  class="m_Slides" src="<?php echo e(asset('resources/imgs/event_home/img_3.jpg')); ?>" width="100%" alt="Chlidren Exercise">
                    <img  class="m_Slides" src="<?php echo e(asset('resources/imgs/event_home/img_4.jpg')); ?>" width="100%" alt="Children Game">
                    <img  class="m_Slides" src="<?php echo e(asset('resources/imgs/event_home/img_5.jpg')); ?>" width="100%" alt="Sword Fight">
                    <img  class="m_Slides" src="<?php echo e(asset('resources/imgs/event_home/img_6.jpg')); ?>" width="100%" alt="Yog Dance Event">
                    <img  class="m_Slides" src="<?php echo e(asset('resources/imgs/event_home/img_7.jpg')); ?>" width="100%" alt="Clamping Children">
                    <img  class="m_Slides" src="<?php echo e(asset('resources/imgs/event_home/img_8.jpg')); ?>" width="100%" alt="Army Flag March">
                    <img  class="m_Slides" src="<?php echo e(asset('resources/imgs/event_home/img_9.jpg')); ?>" width="100%" alt="Morning Walk ">
                    <img  class="m_Slides" src="<?php echo e(asset('resources/imgs/event_home/img_10.jpg')); ?>" width="100%" alt="Army Flag March in border">
                    <img  class="m_Slides" src="<?php echo e(asset('resources/imgs/event_home/img_11.jpg')); ?>" width="100%" alt="Children Flag March">
                    <img  class="m_Slides" src="<?php echo e(asset('resources/imgs/event_home/img_12.jpg')); ?>" width="100%" alt="Girls Flag March">
                </div>
                </a>
             </div>
             <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="card-header new_area_div">
                    <b class="font_b"><?php echo e(__('home_content.Bulletin')); ?>  <!--Bulletin-->
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-12 col-lg-12 rp ">
                                <div class="holder">
                                    <ul id="ticker01">
                                        <li>
                                           <div class="n_head"><?php echo e(__('home_content.fitness')); ?> <!--Fitness--></div>
                                           <div class="down_area"><?php echo e(__('home_content.Download_fitness')); ?> <!--Download : Fitness ki dose Aadha Ghanta Roz.--></div>
                                               <div class=" mob_view">
                                                    <div class="news_date_n"><?php echo e(__('home_content.September')); ?> <!--September--> 29, 2019
                                                       <a class="getlink" href="javascript:void(0);" data-link="https://play.google.com/store/apps/details?id=com.sai.fitIndia"><?php echo e(__('home_content.Read_more')); ?>  <!--Read more-->..</a>
                                                    </div>
                                                </div>
                                        </li>

                                        <li>
                                                <div class="n_head"> <?php echo e(__('home_content.iOS_App')); ?> <!--iOS App--></div>
                                                <div class="down_area"> <?php echo e(__('home_content.mobile_app_iOS')); ?> <!--Download :Fit India mobile app iOS.--></div>
                                                <div class=" mob_view">
                                                    <div class="news_date_n"><?php echo e(__('home_content.Augest')); ?> <!--Augest--> 29, 2021
                                                        <a class="getlink" href="javascript:void(0);" data-link="https://apps.apple.com/us/app/fit-india-mobile-app/id1581063890"><?php echo e(__('home_content.Read_more')); ?> <!--Read more-->..</a>
                                                    </div>
                                                </div>
                                        </li>

                                        <li>
                                            <div class="n_head"><?php echo e(__('home_content.Android_App')); ?> <!--Android App--></div>
                                            <div class="down_area"><?php echo e(__('home_content.mobile_app_android')); ?> <!--Download :Fit India mobile app android.--></div>
                                            <div class=" ">
                                                <div class="news_date_n"><?php echo e(__('home_content.Augest')); ?> <!--Augest--> 29, 2021
                                                    <a class="getlink" href="javascript:void(0);" data-link="https://play.google.com/store/apps/details?id=com.sai.fitIndia"><?php echo e(__('home_content.Read_more')); ?> <!--Read more-->..</a>
                                                </div>
                                      ...
                                      <!--   <li>
                                            <div class="n_head"><?php echo e(__('home_content.Plogrun_Event')); ?>  --> <!--Plogrun Event--><!-- </div>   -->
                                          <!--   <div class="down_area"><?php echo e(__('home_content.Plogrun_registration')); ?> --> <!--Fit India plogrun registration will open soon..--><!-- </div>  -->
                                         <!--    <div class=" mob_view">
                                                <div class="news_date_n"> 1 <?php echo e(__('home_content.October')); ?> , 2021
                                                     <a class="" href="javascript:void(0);" data-link=""></a>
                                                </div>
                                            </div>
                                        </li>  -->
                                     <!--    <li>
                                             <div class="n_head"><?php echo e(__('home_content.Quiz')); ?> </div>
                                            <div class="down_area"><?php echo e(__('home_content.quiz_registration_now')); ?> </div>
                                            <div class="mob_view">
                                                    <div class="news_date_n"> 30 <?php echo e(__('home_content.July')); ?> , 2021
                                                     <a class="getlink" href="javascript:void(0);" data-link="https://fitindia.nta.ac.in/"><?php echo e(__('home_content.Read_more')); ?> ..</a>
                                                     </div>
                                            </div>
                                        </li> -->
                                          <li>
                 ...
                 <div class="col-lg-4 col-md-6 col-12 my-new-flow">
                    <div class="card panel-default new_ticer mt-0 shadow1" style="border: 0px solid rgba(0,0,0,.125);">
                <div class="card-header new_area_div">
                    <b class="font_b"><?php echo e(__('home_content.home-news-letter')); ?>  <!--Bulletin-->
                        <i class="fa fa-angle-double-right new_i" aria-hidden="true" ></i>
                    </b>
                </div>
                    ...
                    <?php if(count($newsletter_data) > 0): ?>
                        <div class="card-body ">
                            <div class="row">
                                <div class="col-xs-12 col-md-12 col-lg-12 rp ">
                                    <div class="holder ">
                                        <ul id="<?php echo e($scrollbaron ?? ''); ?>" style="list-style: none">
                                            
                                            <?php $__currentLoopData = $newsletter_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <li>
                                                    <div class="" style="font-size:14px;">
                                                        ...
                                                        <a href="<?php echo e(url($value['anchor_link']) ?? ''); ?>" target="_blank" download><?php echo e($value['newsletter_title'] ?? ''); ?></a>
                                                    </div>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                ...
                <div class="card-header new_area_div"> <img src="<?php echo e(asset('resources/imgs/news.png')); ?>" >
...
<!-- this section commented -->
           <div class="row mobile_app_base" >
               <div class="col-sm-12 col-md-12 d-flex justify-content-between align-items-end">
                    <div class="mini_area">
                        <img src="<?php echo e(asset('resources/imgs/home/mobile_and_app.png')); ?>" class="fluid-img " />
                    </div>

                    <div class="mobile_area_div text-center" >
                        <img src="<?php echo e(asset('resources/imgs/home/mobileapplogo.png')); ?>"  class="mobile_area_div_cust" alt="Apple" title="Apple Button"/>

                        <div>
                            <p style="font-size:16px;"><?php echo e(__('home_content.CheckFitnessLevel')); ?> <!--Check your Fitness Level Score, Track your Steps.Track your Sleep, Track your calorie intake,Be Part of Fit India Events, Get customized DietPlans Age-wise fitness level--></p>
                            <div class="app_btn" style="padding-bottom: 20px;">
                                <a href="https://apps.apple.com/us/app/fit-india-mobile-app/id1581063890"><img src="<?php echo e(asset('resources/imgs/home/apple.png')); ?>" alt="Apple" title="Apple Button"/></a>
                                <a href="https://play.google.com/store/apps/details?id=com.sai.fitIndia"><img src="<?php echo e(asset('resources/imgs/home/google.png')); ?>" alt="Google" title="Google Button"/></a>
                            </div>
                        <div>
        ...
        <div class="row ">
                <div class="col-sm-12 col-md-12 flex-column">
                    <div class="sec_heading">
                        <h2 class="heading headvideo"><?php echo e(__('home_content.Fitness_Mantra')); ?> <!--Fitness Mantra--></h2>
                    </div>
                    <p><?php echo e(__('home_content.Mission')); ?> <!--Fit India Mission encourages people to become part of Fit India Movement by inculcating at
                    ...
                    <div class="videos_colm">
                        ...
                        <span class="play-icon"><i class="fa fa-play" aria-hidden="true"></i></span>
                         ...
                         <img src="resources/videos/mints-video-cover.jpg" class="img-fluid img_radius" alt="Fitness Ki Dose" title="Fitness Ki Dose Aadha Ghanta Roz" /> -->
                            ...
                            <p class="video-title"><strong><?php echo e(__('home_content.FitIndia_Quiz')); ?> <!--Fit India Quiz--></strong></p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-4">
                    <div class="videos_colm">
                        ...
                        <video poster="resources/videos/fitindiaapp.jpg" controls="">
                            ...
                            <p class="video-title"><strong> <?php echo e(__('home_content.FitIndia_MobileApp')); ?> <!--Fit India Mobile App--></strong></p>
                           <!-- <video poster="resources/videos/fitness-inspiration-video-cover.jpg" controls="">
                            ...
                            <p class="video-title"><strong><?php echo e(__('home_content.Fitness_Inspiration')); ?> </strong></p> -->
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-4">
                    <div class="videos_colm">
                        ...
                        <video poster="resources/videos/mints-video-cover.jpg" controls="">
                            ...
                            <p class="video-title"><strong> <?php echo e(__('home_content.Fitness_KiDose')); ?> <!--Fitness Ki Dose Aadha Ghanta Roz--></strong></p>
                           <!-- <video poster="resources/videos/fitness-inspiration-video-cover.jpg" controls="">
                                <source type="video/mp4" src="resources/videos/Fitness-Inspiration.mp4">
                            </video>
                            <p class="video-title"><strong><?php echo e(__('home_content.Fitness_Inspiration')); ?> </strong></p> -->
   ...
   <section>
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <div class="sec_heading">
                        <h2 class="heading headvideo"><?php echo e(__('home_content.Insights')); ?> <!--Insights--></h2>

                    </div>
                    <p class="text-center"><?php echo e(__('home_content.campaigns')); ?> <!--Fit India has started many campaigns to promote and spread awareness on fitness and the
            ...
            <div class="row home-bx-3">
                <div class="col-sm-12 col-md-4 col-lg-4 n_sec hover_a">
                    <div class="shar_div shadow  bx">
                        <a href="<?php echo e(url('fit-india-school')); ?>">
                            ...
                            <p><?php echo e(__('home_content.School_Certification')); ?> <!--School Certification--></p>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4  n_sec hover_a">
                    <div class="shar_div shadow  bx">
                        <a href="<?php echo e(url('fit-india-youth-club-certification')); ?>">
                            ...
                            <p><?php echo e(__('home_content.Youth_Club_Certification')); ?> <!--Youth Club Certification--></p>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 n_sec hover_a">
                    <div class="shar_div shadow  bx">
                        <a href="<?php echo e(url('champion-and-ambassador')); ?>">
                            ...
                            <p><?php echo e(__('home_content.Ambassadors_Champions')); ?>  <!--Ambassadors & Champions--></p>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 n_sec hover_a">
                    <div class="shar_div shadow  bx">
                        <a href="<?php echo e(url('fitnessprotocols')); ?>">
                            ...
                            <p><?php echo e(__('home_content.Fitness_Protocols')); ?> <!--Fitness Protocols--></p>
                        </a>
                    </div>
                </div>
              ...
              <!--   <div class="col-sm-12 col-md-4 col-lg-4 n_sec hover_a">
                    <div class="shar_div shadow  bx">
                        <a href="<?php echo e(url('fit-india-dialogue')); ?>">
                  ...
                  <div class="col-sm-12 col-md-4 col-lg-4 n_sec hover_a">
                    <div class="shar_div shadow  bx">
                        <a href="<?php echo e(url('fit-india-yoga-centres')); ?>">
                            ...
                            <p><?php echo e(__('home_content.Fit_India_Yoga')); ?> <!--Fit India Yoga Centres--></p>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4  n_sec hover_a">
                    <div class="shar_div shadow  bx">
                        <a href="<?php echo e(url('schooldashboard')); ?>">
                            <img src="resources/images/home-thumbs/Dashboard.jpg" class="img-fluid img_radius_lr"
                                alt="Dashboard" title="Fit India Dashboard" />
                            <p><?php echo e(__('home_content.Fit_India_Dashboard')); ?> <!--Fit India Dashboard--> </p>
                        </a>
                    </div>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4 n_sec hover_a">
                    <div class="shar_div shadow  bx">
                        <a href="<?php echo e(url('your-stories')); ?>">
                            ...
                            <p><?php echo e(__('home_content.Share_Your_Story')); ?>  <!--Share Your Fitness Story--></p>
                        </a>
                    </div>
                </div>
     ...
     <section style="background: rgb(2 1 129 / 5%);">
      <!-- ---------------------Social Feeds-------------------------------------------- -->
        <div class="container on-print">
            <div class="row">
                <div class="col-12">
                   <!--  <h3 class="heading headvideo"><?php echo e(__('home_content.Social_Feeds')); ?></h3> -->
                    <h3 class="heading headvideo"><?php echo e(__('home_content.Social_Feeds')); ?> <!--Social Feeds--></h3>
                </div>
            </div>
			<div id="container">
    ...
    <section>
        <div class="sup_org on-print">
            <h3 class="heading headvideo"><!-- <?php echo e(__('home_content.Supporting_Organisations')); ?> --> <!--Supporting Organisations--></h3>
            <div class="slider">
                    ...
                    <ul class="slides">
                        <li>
                            <a class="getlink" href="javascript:void(0);" data-link="https://www.education.gov.in/en">
                                <img typeof="foaf:Image" src="<?php echo e(asset('resources/images/gov-logos/ministryofeducation.png')); ?>"
                        ...
                        <li>
                            <a class="getlink" href="javascript:void(0);" data-link="https://nyks.nic.in/">
                                <img typeof="foaf:Image" src="<?php echo e(asset('resources/images/gov-logos/nyks.png')); ?>"
                        ...
                        <li>
                            <a class="getlink" href="javascript:void(0);" data-link="https://nss.gov.in/">
                                <img typeof="foaf:Image" src="<?php echo e(asset('resources/images/gov-logos/nss.png')); ?>"
                        ...
                        <li >
                            <a class="getlink" href="javascript:void(0);" data-link="https://www.itbpolice.nic.in/">
                                <img typeof="foaf:Image" src="<?php echo e(asset('resources/images/gov-logos/itbp.png')); ?>"
                        ...
                        <li>
                            <a class="getlink" href="javascript:void(0);" data-link="https://wcd.nic.in/">
                                 <img typeof="foaf:Image" src="<?php echo e(asset('resources/images/gov-logos/ministryofchildanddev.png')); ?>"
                        ...
                        <li>
                            <a class="getlink" href="javascript:void(0);" data-link="https://www.cbse.gov.in/">
                                <img typeof="foaf:Image" src="<?php echo e(asset('resources/images/gov-logos/cbsc.png')); ?>"
                        ...
                        <li>
                            <a class="getlink" href="javascript:void(0);" data-link="https://www.cisce.org/">
                                <img typeof="foaf:Image" src="<?php echo e(asset('resources/images/gov-logos/icse.png')); ?>"
                        ...
                        <li>
                            <a class="getlink" href="javascript:void(0);" data-link="https://www.mygov.in/">
                                 <img typeof="foaf:Image" src="<?php echo e(asset('resources/images/gov-logos/govofindia.png')); ?>"
                        ...
                        <li>
                            <a class="getlink" href="javascript:void(0);" data-link="https://sportsauthorityofindia.nic.in/">
                                    <img typeof="foaf:Image" src="<?php echo e(asset('resources/images/gov-logos/sai.png')); ?>"
                        ...
                        <li>
                            <a class="getlink" href="javascript:void(0);" data-link="https://kheloindia.gov.in/">
                                <img typeof="foaf:Image" src="<?php echo e(asset('resources/images/gov-logos/kheloindia.png')); ?>"
...
<script src="<?php echo e(asset('resources/js/ajaxjquery.min.js')); ?>"></script>

<script src="<?php echo e(asset('resources/js/jquery.flexslider.js')); ?>"></script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fitindiaweb_gitnew\resources\views/home.blade.php ENDPATH**/ ?>
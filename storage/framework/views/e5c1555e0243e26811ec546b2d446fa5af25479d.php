...
<div>
  ...
  <a  href="register?role=bmFtby1maXQtaW5kaWEteW91dGgtY2x1Yg==">
   <img src="<?php echo e(url('resources/imgs/09website-banner-namo-fit-india-cycling-club-Imagepng.png')); ?>" alt="youthclub" class="img-fluid expand_img" />
  </a>
</div>
...
<div class="container">
    <div class="row">
        ...
        <a class="freedombtn3" href="<?php echo e(url('resources/pdf/how-to-register-for-namo-fit-india-cycling-youth-club.pdf')); ?>" target="_blank">How To Register</a>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fitindiaweb_gitnew\resources\views/namo-fit-india-cycling-club.blade.php ENDPATH**/ ?>
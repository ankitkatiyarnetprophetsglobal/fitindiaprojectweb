...
<head>
    ...
    <!-- <link rel="stylesheet" href="<?php echo e(asset('resources/fonts/bootstrap.min.css')); ?>" media="screen"> -->
    ...
    <!-- <link href="<?php echo e(asset('resources/css/print.min.css')); ?>" rel="stylesheet" media="all">   -->
...
<body>
	...
	<?php } ?>
<div class="container-fluid" id="<?php echo $__env->yieldContent('pageid'); ?>">
    <div class="cust_navbar_mob"><p>Accessibility Options</p></div>
    <!-- Top Header Bar -->
    <div id="top-header">
    </div>
    ...
    <!-- <div class="top-header_Flex"> -->
            ...
            <div class="top_head_item on-print">                        
               ...
               <!--  <a  class="btn btn-primary video-btn" href="<?php echo e(route('freedom-run-4.0')); ?>"><?php echo e(__('home_content.Freedomrun')); ?>
              ...
              <ul> 
                        <?php if(auth()->guard()->guest()): ?>
                                ...
                                <?php if(Route::has('login')): ?>
                                    <span><a class="nav-link" href="<?php echo e(route('login')); ?>"><?php echo e(__('home_content.Login')); ?> <?php //{{ __('Login') }} ?> </a></span>
                                <?php endif; ?>
                                </li>
                                <li class="nav-item l_area reg">
                                <?php if(Route::has('register')): ?>
                                    <span><a class="nav-link" href="<?php echo e(route('register')); ?>"><?php echo e(__('home_content.Register')); ?> <?php //{{ __('Register') }} ?></a></span>
                                    <?php endif; ?>
                                </li>
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                ?>  
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="<?php echo e(url('dashboard')); ?>" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                                    <?php echo e($scname); ?>
                                ...
                                <div class="dropdown-menu  top-bar-li cus_drop " aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="<?php echo e(url('dashboard')); ?>" >
                                       <?php echo e(__('home_content.My_account')); ?> <?php //{{ __('My Account') }} ?>
                                    </a>
									<?php if(Auth::user()->role == 'school'): ?>
									<a class="dropdown-item" href="<?php echo e(url('school-profile')); ?>">
                                       <?php echo e(__('home_content.Edit_Profile')); ?> <?php // {{ __('Edit Profile') }} ?>
                                    </a>
									<?php else: ?>
									...
									<?php endif; ?>
                                    <a class="dropdown-item last_child"  href="<?php echo e(route('logout')); ?>"  data-toggle="modal" data-target="#logoutDivId">
									<!--
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" 
													 -->
										<?php echo e(__('home_content.Logout')); ?>		 
                                        <?php // {{ __('Logout') }} ?>
                                    </a>
          ...
          <div class="log_reg">
            <div class=" log_status">
                    <ul class="navbar-nav ml-auto cust_navbar on-print">
                      <!--<li class="nav-item"> <a href="<?php echo e(url('screen-reader-access')); ?>">Screen Reader Access</a></li>-->
                     
                    <!--  <li class="nav-item"> <a href=""  data-toggle="modal" data-target="#logoutDivId">modal</a></li> -->
                    <li class="nav-item"> <a href="#<?php echo e($active_section); ?>"><?php echo e(__('home_content.Skip_to_Main_Content')); ?>	<!--Skip to Main Content--></a></li>
                    ...
                    <li class="nav-item" id="printId"> <a href="Javascript:void(0);" onclick="printFile()"><?php echo e(__('home_content.Print')); ?></a></li>
                    <li class="nav-item dropdown">
						<a id="navbarDropdown" class="nav-link dropdown-toggle" href="<?php echo e(url('dashboard')); ?>" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(__('home_content.Language')); ?> </a>
						<div class="dropdown-menu  top-bar-li cus_drop cus_drop_EH " aria-labelledby="navbarDropdown">
						  <a class="dropdown-item" href="<?php echo e(url('lang/en')); ?>"><?php echo e(__('home_content.English')); ?></a>
						  <a class="dropdown-item" href="<?php echo e(url('lang/hn')); ?>"><?php echo e(__('home_content.Hindi')); ?> </a>
						</div>
					</li>					
              </ul>               
            </div>
...
// Include CSS file
    ...
    <!-- Footer -->
        <?php echo $__env->make('layouts.footer1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- Footer end-->
...
<?php /**PATH C:\xampp\htdocs\fitindiaweb_gitnew\resources\views/layouts/app.blade.php ENDPATH**/ ?>
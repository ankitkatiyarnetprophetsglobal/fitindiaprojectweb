            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item mer_banner active">
                        <img src="{{ asset('resources/imgs/event2023/WebBannerHindi2.jpg') }}" class="d-block w-100" alt="Fit-india-school-week-2021" title="Fit-india-school-week-2021">
                    ...
                    <div class="carousel-item mer_banner">
                        <img src="{{ asset('resources/imgs/event2023/WebBannerHindi1.jpg') }}" class="d-block w-100" alt="Fit-india-school-week-2021" title="Fit-india-school-week-2021">
                        <div class="some-absolute-div bannerPos1">
                            <div class="centered-in-absolute">
                                {{-- <form action="{{route('download-school-banner')}}" method="POST"> --}}
                                    @csrf
                    ...
                    <div class="carousel-item mer_banner">
                        ...
                        <img src="{{ asset('resources/imgs/event2023/WebBannerEnglish1.jpg') }}" class="d-block w-100" alt="Fit-india-quiz" title="Fit-india-quiz"> </a>
                        <div class="some-absolute-div bannerPos2">
                            <div class="centered-in-absolute">
                                {{-- <form action="{{route('download-school-banner')}}" method="POST"> --}}
                                    @csrf
...
<div class="container-fluid">
    <div class="base_mer " style="background:#f7f7f7;">
        ...
        {{-- <div class="row ">
            <div class="col-sm-12 col-md-6 col-lg-6 mb-3 bm_inner">
                <img src="{{ url('resources/imgs/event2023/nsdschoolbackdrop.jpg') }}" class="img-fluid shadow_m " title="nsd school backdrop" alt="nsd school backdrop" />
            </div>
            
            <div class="col-sm-12 col-md-6 col-lg-6 mb-3 bm_inner" style="display:inline; height:60%; width:60%;">
                <img style="display:inline; height:400px; width:60%;" src="{{ url('resources/imgs/event2023/nsdschoolstandee.jpg') }}" class="img-fluid shadow_m " title="nsd school standee" alt="nsd school standee" />
            </div>
        ...
        <div class="row align-items-center justify-content-center my-5">
            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                <div class="image_holder">
                    <span class="image_section">
                        <img src="{{ url('resources/imgs/event2023/BackdropHindi.jpg') }}" />
                    </span>
    
                    <span class="img_txt_section">
                        <a href="resources/imgs/event2023/BackdropHindi.ai" class="btn btn-primary btn-sm" data-icon="G">Download Backdrop</a>
                    </span>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                <div class="image_holder">
                    <span class="image_section">
                        <img src="{{ url('resources/imgs/event2023/Standee(Hindi).jpg') }}" />
                    </span>
    
                    <span class="img_txt_section">
                        <a href="resources/imgs/event2023/Standee(Hindi&English).ai" class="btn btn-primary btn-sm" data-icon="G">Download Standee</a>
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center justify-content-center my-5">
            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                <div class="image_holder">
                    <span class="image_section">
                        <img src="{{ url('resources/imgs/event2023/BackdropEnglish.jpg') }}" />
                    </span>
    
                    <span class="img_txt_section">
                        <a href="resources/imgs/event2023/BackdropEnglish.ai" class="btn btn-primary btn-sm" data-icon="G">Download Backdrop</a>
                    </span>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                <div class="image_holder">
                    <span class="image_section">
                        <img src="{{ url('resources/imgs/event2023/Standee(English).jpg') }}" />
                    </span>
                ...
                <div class="mt-3">
                    <div class=" mer_logo">
                        ...
                        <div class="d-flex justify-content-between align-items-center mer_mobile">
                            ...
                            <a class="mer_logo_form " href="javascript:void(0)" style="cursor: default;" data-icon="G">jpg</a>
                            <a class="mer_logo_form " href="javascript:void(0)" style="cursor: default;" data-icon="G">pdf</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="base_mer ">
        <div class="base_mer_inner">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="mt-3">
                    <div class=" mer_logo">
                        ...
                        <div class="d-flex justify-content-between align-items-center mer_mobile">
                            <a class="mer_logo_form " href="{{ url('resources/imgs/downloadofficiallogos/fitindialogo/png/fitindiaLogos.zip') }}" data-icon="G">png</a>
                            <a class="mer_logo_form" href="javascript:void(0)" data-icon="G" style="cursor: default;">jpg</a>
                            <a class="mer_logo_form" id="merchandisId" href="javascript:void(0)" data-icon="G" style="cursor: default;">pdf</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row ">
                <div class="col-sm-12 col-md-4 col-lg-4 mb-3 bm_inner">
                    <img src="{{ url('resources/imgs/merchant/BlueT-shirt-3.png') }}" class="img-fluid shadow_m " title="AzadiKaAmritMahotsav_Hindi" alt="AzadiKaAmritMahotsav_Hindi" />
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4 mb-3 bm_inner">
            ...
            <div class="row ">
                <div class="col-sm-12 col-md-6 col-lg-6 mb-3 bm_inner">
                    <img src="{{ url('resources/imgs/merchant/WhiteTshirt1.png') }}" class="img-fluid shadow_m " title="Fitness ki dose aadha ghanta roz" alt="Fitness ki dose aadha ghanta roz" />
                </div>
                <div class="col-sm-12 col-md-6 col-lg-6 mb-3 bm_inner">
            ...
            {{-- <div class="row ">
                <div class="col-sm-12 col-md-6 col-lg-6 mb-3 bm_inner">
                    <img src="{{ url('resources/imgs/merchant/Blue.png') }}" class="img-fluid shadow_m " title="Fitness ki dose aadha ghanta roz" alt="Fitness ki dose aadha ghanta roz" />
                </div>
                <div class="col-sm-12 col-md-6 col-lg-6 mb-3 bm_inner">
                    <img src="{{ url('resources/imgs/merchant/White.png') }}" class="img-fluid shadow_m " title="Fitness ki dose aadha ghanta roz" alt="Fitness ki dose aadha ghanta roz" />
                </div>
            </div> --}}
        </div>
    </div>

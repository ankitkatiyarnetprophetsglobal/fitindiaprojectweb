...
<body style="padding:0;margin:0;">
  <div style="position:relative;margin:-28px; "><img src="{{ asset('resources/imgs/certificate/school_week_2022/participant.jpg') }}"  alt="" style="width:100%;margin:0px auto;height:758px;"></div>

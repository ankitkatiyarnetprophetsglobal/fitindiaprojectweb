									...
									<article class="cards-list">
										...
										<div class="join-btn" style="position: inherit;">
											<div class="editdel" style="padding: 10px 15px 5px 15px; display:flex; align-items:center; justify-content:center;">
												...
												<form action="{{ route('school-event-destroy',$event->id) }}" method="POST"  class="form_del">
												  @csrf
												  @method('DELETE')
											...
											<div class="add mb-1">
												<a class="add-participants btn-magenta" href="{{ url('event-uploadexcel', $event->id )}}" style="background-color:#7E00DE; border-color:#7E00DE; font-size:12px;">SUGGEST OUTSTANDING SPORT TALENT</a>
											</div>

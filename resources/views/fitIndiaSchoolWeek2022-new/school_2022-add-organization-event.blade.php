											...
											<div class="um-field">
												...
												<div class="row">
													<div class="col-sm-12 col-md-6">
														...
														<input type="date" name="from_date" class="form-control" id="from_date" value="{{ old('from_date') }}" maxlength="10" min="2022-11-15" max='2022-12-15'>
														...
														<div class="col-sm-12 col-md-6">
																<div class="form-group ">
																	To Date
																  <input type="date" name="to_date" class="form-control" id="to_date" value="{{ old('to_date') }}" maxlength="10" min="2022-11-15" max='2022-12-15'>

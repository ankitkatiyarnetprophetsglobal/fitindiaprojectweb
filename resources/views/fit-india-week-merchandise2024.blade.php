            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 my-3">
                <div class="image_holder">
                    <span class="image_section">
                        <img src="{{ url('resources/imgs/swacchta-freedom-run-5/swacchta-freedom-Run-5-Backdrop.jpeg') }}" />
                    </span>
    
                    <span class="img_txt_section">
                        <a href="resources/imgs/swacchta-freedom-run-5/swacchta-freedom-Run-5-Backdrop.zip" class="btn btn-primary btn-sm" data-icon="G">Download Backdrop</a>
                    </span>
                </div>
            </div>             --}}
        ...
        <div class="base_mer_inner">
                ...
                <div class="mt-3">
                    <div class=" mer_logo">
                        ...
                        <div class="d-flex justify-content-between align-items-center mer_mobile">
                            ...
                            <a class="mer_logo_form" href="{{ url('resources/imgs/national-sports-day-2024/design-blue-yellow-t-shirt.zip') }}" data-icon="G">jpg</a>
                            <a class="mer_logo_form" id="merchandisId" href="javascript:void(0)" data-icon="G">pdf</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row ">
                <div class="col-sm-12 col-md-4 col-lg-4 mb-3 bm_inner">
                    <img src="{{ url('resources/imgs/national-sports-day-2024/design-blue-navy-t-shirt.png') }}" class="img-fluid shadow_m custom-img-h" title="AzadiKaAmritMahotsav_Hindi" alt="AzadiKaAmritMahotsav_Hindi" />
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4 mb-3 bm_inner">
                    <img src="{{ url('resources/imgs/national-sports-day-2024/design-blue-yellow-t-shirt.jpeg') }}" class="img-fluid shadow_m custom-img-h" title="AzadiKaAmritMahotsav_Hindi" alt="AzadiKaAmritMahotsav_Hindi" />
                </div>
                {{-- <div class="col-sm-12 col-md-4 col-lg-4 mb-3 bm_inner">

            ...
            <div class="forMob on-print">
              <ul> 
                        @guest
                                ...
                                @if (Route::has('login'))
                                    <span><a class="nav-link" href="{{ route('login') }}">{{ __('home_content.Login')}} <?php //{{ __('Login') }} ?> </a></span>
                                @endif
                                </li>
                                <li class="nav-item l_area reg">
                                @if (Route::has('register'))
                                    <span><a class="nav-link" href="{{ route('register') }}">{{ __('home_content.Register')}} <?php //{{ __('Register') }} ?></a></span>
                                    @endif
                                </li>

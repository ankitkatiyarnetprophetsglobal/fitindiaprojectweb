	  ...
	  <div class="row">
		<div class="col-12">
	      ...
	      <!--   </ul>	 -->
				...
				<li class="nav-item {{ (request()->is('fit-india-namo-club')) ? 'active' : 'active' }}">					
					<a class="nav-link  home-menu {{ (request()->is('fit-india-namo-club')) ? 'active' : '' }}" href="{{url('fit-india-namo-club')}}">{{ __('home_content.namo-fitIndia-club')}}</span></a>
				</li>

...
<div class="banner_area">
            ...
            <form action="{{ route('mobile-download-e-cert') }}" method="POST" onsubmit="return chkcaptchaval();">
                @csrf
                                <div class="um-field">
					...
					<?php 
                        ...
                        $participant_names = $users->participant_names;
						//$participant_names = explode(PHP_EOL, $participant_names);
						$participant_names = @unserialize($users->participant_names);

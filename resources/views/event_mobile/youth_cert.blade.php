...
<div class="banner_area">  
  <?php
	...
	$kuserid=(!empty($_REQUEST['auth_id']) ? $_REQUEST['auth_id'] : (!empty($userid) ? $userid : $user_id));	
  ?> 	 
    <div class="container">
        <div class="et_pb_row">
            <div class="row ">					
         ...
         <!-- Flag Request Start -->
			...
			<div id="tab-12977" class="star-rating-content current" >
				...
				<form name="createeventform" method="post" action="{{route('storeyouthcert1')}}" enctype="multipart/form-data">
					@csrf
					<?php } ?>
					...
					<div class="inner" >
						...
						<div class="um-field">
								...
								<input type="hidden" name="user_id" value="{{ $kuserid }}"/>
						</div>
					    @php $ii= 1; @endphp	
										...
										switch ($questypeid) {
											...
											case "103": ?>
												...
												<div class="sub_ques_row_cont">
													...
													<form method="post" action="{{route('updateyouthcert1')}}" enctype="multipart/form-data">
													@csrf

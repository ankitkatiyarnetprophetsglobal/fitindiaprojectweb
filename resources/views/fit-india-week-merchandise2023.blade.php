            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 my-3">
                {{-- <div class="image_holder">
                    <span class="image_section">
                        <img src="{{ url('resources/imgs/fitindiaweek2023/backdrop/4x8bckdrop.png') }}" />
                    </span>
    
                    <span class="img_txt_section">
                        <a href="resources/imgs/fitindiaweek2023/backdrop/BrandingPanel.zip" class="btn btn-primary btn-sm" data-icon="G">Download Backdrop</a>
                    </span>
                </div> --}}
            </div>            

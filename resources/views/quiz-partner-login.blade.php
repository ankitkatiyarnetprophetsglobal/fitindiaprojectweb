    ...
    <div class="container ">
      ...
      <div class="row d-flex justify-content-center align-items-center height100">
            <div class="col-sm-8  col-md-4  ">
                ...
                <div class="card ">
                     <div class="bg_bk">
                         <img src="resources/imgs/quiz/quizlogo.png" class="fluid-img"/>
                     </div>
                    <div class="card-body">
                        <!-- <p class="description text-lg-right"></p>-->
                        <form class="form-example" action="{{ route('quiz-partner-login') }}" method="post">
                            @csrf
                            <h1 class="mt-0 text-center">Quiz Partner Login</h1>
                            <p class="description">
                            ...
                            <p class="description text-center mt-2 mb-1 pt-2">Do not have Account? <a
                                    href="{{ route('quiz-partner-form') }}"> Register </a></p>

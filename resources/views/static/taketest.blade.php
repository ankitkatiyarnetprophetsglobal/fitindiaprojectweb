...
<style>
    #btnPartial,#btnFlamingo,#btnNaukasana,#btnVrikshasana{
            ...
            <div class="container">
                <div class="row" id="testBind" runat="server" style="margin-top: 25px;" >
                                            ...
                                            <div class="row">
                                                ...
                                                <div
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id='countFlamingo' maxlength="3" Placeholder="00"
                                                            runat='server' onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                ...
                                                <div class="col-xs-4 col-sm-4 take-test-btn-col">
                                                    <div class="form-group" style="padding-right: 5px;">
                                                        <label for="usr">&nbsp;</label>
                                                        <button id='btnFlamingo' runat='server' 
                                                            class='take-test-save-btn'>{{ __('taketest.label6') }}</button>
                                                    </div>
                                                </div>
                                            ...
                                            @foreach ($data as $value)
                                                ...
                                                @if ($value->TestTypeId == '1001')
                                                    <div class="last-updated-test" id="upVrikshasana" runat="server"
                                                        ...
                                                        <img src="{{ url('resources/dotnetimages/clock.png') }}" />
                                                        {{ __('taketest.label3') }} <span class="last-score"
                                                            id="upScoreVrikshasana" runat="server">{{ $value->Score / 1000 . ' ' . 'Sec' }}</span><span
                                        ...
                                        <div class="take-test-section">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-4 col-sm-4 take-test-btn-col">
                                                    <div class="form-group" >
                                                        <label for="usr">&nbsp;</label>
                                                        <button id='btnPartial' runat='server' 
                                                            class='take-test-save-btn'>{{ __('taketest.label6') }}</button>
                                                    </div>
                                                </div>
                                            ...
                                            @foreach ($data as $value)
                                                ...
                                                @if ($value->TestTypeId == '1002')
                                                    <div class="last-updated-test" id="upNaukasana" runat="server"
                                                        ...
                                                        <img src="{{ url('resources/dotnetimages/clock.png') }}" />
                                                        {{ __('taketest.label3') }} <span class="last-score"
                                                            id="upScoreNaukasana" runat="server">{{ $value->Score/1000 . ' ' . 'Sec' }}</span>
                                                            
                                                            <span class="last-time" id="upTimeNaukasana"
                                                            runat="server">{{ '[' . $value->TIME . ']' }}</span>
                                                    </div>
                                    ...
                                    @if ($value->TestTypeId == '57')
                                        <div class="last-updated-test" id="upPush" runat="server"
                                            ...
                                            {{ __('taketest.label3') }} <span class="last-score" id="upScorePush"
                                                runat="server">{{ $value->Score . ' ' . 'Times' }}</span><span
                                ...
                                <div class="row">
                                    ...
                                    <div
                                        ...
                                        <div class="form-group">
                                            ...
                                            onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" Class='form-control' type="number" />
                                        </div>
                                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-md-offset-4">
                        <a href="javascript:void(0)" class="tast-page-view-btn" runat="server"
...
if (response.data != null && response.data.length > 0) {
    ...
    if (response.data[0].AgeGroupId == 2 && response.data[0].TestTypeId == 19) {
       
        $('#lblHeading').html(label_data['label500']);
        $('#testHeading').html(label_data['label500']);
    } else if (response.data[0].AgeGroupId == 2 && response.data[0].TestTypeId == 6) {
        $('#lblHeading').html(label_data['label89']);
        $('#testHeading').html(label_data['label89']);
    } else if (response.data[0].AgeGroupId == 2 && response.data[0].TestTypeId == 8) {
        $('#lblHeading').html(label_data['label501']);
        $('#testHeading').html(label_data['label501']);
    } else if (response.data[0].AgeGroupId == 2 && response.data[0].TestTypeId == 54) {
        $('#lblHeading').html(label_data['label502']);
        $('#testHeading').html(label_data['label502']);
    } else if (response.data[0].AgeGroupId == 2 && response.data[0].TestTypeId == 57) {
        $('#lblHeading').html(label_data['label503']);
        $('#testHeading').html(label_data['label503']);
    ...
    else if (response.data[0].AgeGroupId == 1 && response.data[0].TestTypeId == 6) {
        $('#lblHeading').html(label_data['label83']);
        $('#testHeading').html(label_data['label83']);
    }
    else if (response.data[0].AgeGroupId == 1 && response.data[0].TestTypeId == 60) {
    ...
    <script type="text/javascript">
        ...
        document.getElementById('btn2mt').addEventListener('click', function savebtn600mt(e) {
            ...
            if (Number(Min2.value) == 0 && Number(Sec2.value) == 0 && Number(Ms2.value) == 0) {
                ...
                lblerror2.innerHTML = "{{ __('taketest.label303') }}";
                divloader.style.display = "none";
                return false;
            }
            if (Min2.value == "") {
                err2.style.display = "block";
                lblerror2.innerHTML = "{{ __('taketest.label39') }}";
                divloader.style.display = "none";
                return false;
            }
            ...
            if (Sec2.value == "") {
                err2.style.display = "block";
                lblerror2.innerHTML = "{{ __('taketest.label40') }}";
                divloader.style.display = "none";
                return false;
            }
        ...
        document.getElementById('btnVrikshasana').addEventListener('click', function backscratch(e) {
            ...
            if (Number(SecVrikshasana.value) > 0 && Number(msVrikshasana.value) > 0) {
                var scoreVrikshasana = Number(SecVrikshasana.value) * 1000 + Number(msVrikshasana.value);

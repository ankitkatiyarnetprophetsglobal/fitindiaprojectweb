    ...
    <div class="container back-btn-set">
       ...
       <div class="col-auto">
         <a href="{{ url('homeaddusers') }}" class="header-back-btn back-btn-set"  style="display: flex; justify-content: end; margin-right:20px !important;">
            <img src="{{url('resources/dotnetimages/switch-user.png')}}" />
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 khelo-text-padding">
                        ...
                        @endphp
                            ...
                            <div class="share-icon re-take-text">
                                ...
                                <span class="download-i re-take"><img src="{{url('resources/images/re-test_i.png')}}"><span class="mob-test">{{ __('taketest.label304') }}</span></a>
                            </div>
                           </div>
                        </form>
                    ...
                    <div class="user-information">
                        <div class="student-info">
                            ...
                            @php
                                ...
                                // $url_segemnt = explode('/',$get_url);
                                // $tem_id = $url_segemnt[3];
                                $tem_id = session::get('ParentUserId');
                                $ParentId = session::get('ParentUserId');
                                // dd($ParentId);
                                // dd($tem_id);
                                // dd($userprofile[0]['PhotoName']);
                            @endphp
                            {{-- <div id="ContentPlaceHolder1_ProfileDiv" class="student-img"><img id="imgStudentImage" runat="server" src="{{url('resources/dotnetimages/SchoolImages/School_user_male.png')}}" alt="user" class="circle"></div> --}}

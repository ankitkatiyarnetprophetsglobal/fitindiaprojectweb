                ...
                <div class="col-md-8 offset-md-2">
                    <div class="card">
                        ...
                        <div class="backtohome"><a class="btn btn-light btn-back custom-btn" href="{{ route('roadtotokyo',$encrypted) }}"> < Go Back Home <a></div>
                            <h1 class="mt-lg-3 pb-lg-3"> {{ $userdata->name }} रोड टू टोक्यो  2020 lucky winners
                            </h1>
                                    ...
                                    <div class="card today-card">
                                        <div class="card-body">
                                            ...
                                            <div class="usr-dtls">
                                                ...
                                                <div class="info-box-name">{{ $winners[0]->name }} </div>
							...
							<div class="row">
							 ...
							 परिणाम कल घोषित किए जाएंगे। कृपया कल आकर देखिए।
							</div>
                            </div>
							@endif
								...
								<div class="col-md-4">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="info-box-name">{{ $winner->name }} </div>

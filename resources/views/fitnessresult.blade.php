								 ...
								 ?>
										...
										<div class="p_area">
											...
											<div class="progress md-progress my-0" style="height: 20px">
												...
												<?php if(empty($per)){ ?>
													<div style="text-align:center"  class="p-2">Your Score is 0 out of 5</div>
												<?php }else{ ?>
													<div style="text-align:center" class="p-2"> Your Score is {{ $score }} out of 5 </div>
												<?php } ?>
										</div>
										...
										<div class=" mt-2" style="text-align:center;font-size: 20px; padding:0 15px;">
											<p class="p-0 text-center p_sizeP" ><strong>Thank you for participating.  </p>
<!-- 					
										...
										<div class="p_area mt-2 d-flex  justify-content-around">
											<?php $nm = array('email' => $email ); ?>
											 @if(Route::has('fitness-quiz'))
                                             <a class="btn btn-success mr-3 btn-back" href="{{ route('fitness-quiz')}}">Go to Home Page </a>
										    @endif
											<!--<a class="btn btn-success mr-3 btn-back" href="" target="_blank" > डाउनलोड सर्टिफिकेट</a>--> 
										</div>
										<!-- <div class="p_area mt-2"> &nbsp; </div>

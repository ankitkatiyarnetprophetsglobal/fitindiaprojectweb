          ...
          <form name="championform" method="post" action="champ-store" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12">
                  <br>
                <div class="form-group">
                      <a style="color:black!important" class="champ_btn" href="{{ asset('wp-content/uploads/doc/Guidelines-for-Fit-India-Champion.pdf') }}" target="_blank">Guidelines of Fit India Champion</a>
                  </div>
                  </div>
...
<script>
  $(function() {
    ...
    //     if(follwer_sum > 99999){
    //         form.submit();
    //     }else{
    //         alert("Your Social media follower's count should be greater than or equal to 1,00000");
    //     }
    // }
  });
});

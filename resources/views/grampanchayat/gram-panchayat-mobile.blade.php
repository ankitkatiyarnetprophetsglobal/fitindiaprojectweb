...
<div class="banner_area">
    <img src="{{ asset('resources/imgs/fitindia-bg-white.jpg') }}" alt="about-fitindia" class="img-fluid expand_img" />
        ...
        <div class="container cont_area_5">
            <div class="et_pb_row">
                <div class="row ">
              ...
              <fieldset class="scheduler-border">
                ...
                <div class="col-sm-12 col-md-12">
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-12 col-md-12 mob-p-r">
                  <div class="form-group ">
                      <a style="color:black!important" class="champ_btn" href="{{ asset('wp-content/uploads/doc/Guidlines-Gram Panchayat.pdf') }}">Guidelines of Fit India Gram Panchayat Ambassador</a>
                  </div>
              </div>

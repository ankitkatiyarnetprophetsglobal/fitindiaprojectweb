        ...
        <div class="col-sm-12 col-md-12 bg_head  ">
            ...
            <!--     <p>Dear Participant,<br/>Namaste,</p> -->
                   ...
                   <ol class="list-num-count">
                    <li>The quiz is being organised by the Fit India Mission and is available of Fit India Mobile Application only and no other channel.</li>
                    <li>
                    The quiz is open for all Indian residents across age groups.
                    </li>
                    <li>
                   ...
                   The organisers reserve the rights to disqualify participants, refuse entry, or discard entries, if such instances or participation is considered to be detrimental to the competition, or Additionally, any entry will be considered void if the information submitted is illegible, incomplete, false, or erroneous.
                    ...
                    <li>
                    The selection of the daily winner will be based on the first person providing the right answer. The time stamp for the response shall be recorded will be utilized for identifying the winner.
                    </li>
                    <!--<li>The list of winners will be declared on or after 5th March 2022.</li> -->
                    <li>

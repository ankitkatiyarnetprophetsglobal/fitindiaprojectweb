                            ...
                            <div class="description_box">
								...
								<div class="all-events">
									<select class="select_location select_location_width" >
										{{-- <option <?php if($year=='22'){ echo "selected='selected'"; }?> value="{{ url('school-events') }}">Fit India School Week 2022</option> --}}
										<option <?php if($year=='22'){ echo "selected='selected'"; }?> value="{{ url('school-events') }}">National Sports Day 2023</option>
									...
									<article class="cards-list">
										...
										<div class="card-details" style="padding: 0px 15px 10px 15px;">
											...
											<div class="card-right">
												...
												<div class="card-title card-title-cus">
												 {{-- <h4>FIT India School Week</h4> --}}
												 <h4>National Sports Day 2023</h4>
										...
										<div class="join-btn" style="position: inherit;">
											<div class="editdel" style="padding: 10px 15px 5px 15px; display:flex; align-items:center; justify-content:center;">
												...
												{{-- <a class="edit-event" style="width: 50%; background-color:#FFAA00; text-transform:uppercase; color:#ffffff; font-size:12px; " href="{{ url('school-run-update', $event->id) }}"><img src="{{url('resources/imgs/school_event/edit-fill.svg')}}" alt="" style="margin-right:2px "> Edit</a> --}}
												{{-- <a class="edit-event" style="width: 50%; background-color:#FFAA00; text-transform:uppercase; color:#ffffff; font-size:12px; " href="{{ url('event-run-update', $event->id) }}"><img src="{{url('resources/imgs/school_event/edit-fill.svg')}}" alt="" style="margin-right:2px ">Edit</a> --}}
											...
											<div class="add mb-1" >
												{{-- <a class="add-participants btn-magenta" href="{{ url('school-run-update', $event->id) }}" style="background-color:#7E00DE; border-color:#7E00DE; font-size:12px;"  >ADD EVENT PICTURES & VIDEOS</a> --}}
												{{-- <a class="add-participants btn-magenta" href="{{ url('event-run-update', $event->id) }}" style="background-color:#7E00DE; border-color:#7E00DE; font-size:12px;"  >ADD EVENT PICTURES & VIDEOS</a> --}}
											</div>
											{{-- <div class="add mb-1">
												<a class="add-participants btn-magenta" href="{{ url('event-event-uploadexcel', $event->id )}}" style="background-color:#7E00DE; border-color:#7E00DE; font-size:12px;">SUGGEST OUTSTANDING SPORT TALENT</a>
											</div> --}}
												...
												<?php 
												  /*  if( in_array( "" ,$pnt_arr ) || in_array( "" ,$kms_arr ))
													...
													<?php 
														...
														{{-- <a class="dwnl-btn add-participants" href="{{ url('school-certificate-process', $event->id) }}" style="background-color:#7E00DE; border-color:#7E00DE;  font-size:12px;">DOWNLOAD CERTIFICATE</a> --}}
														{{-- <a class="dwnl-btn add-participants" href="{{ url('event-certificate-process', $event->id) }}" style="background-color:#7E00DE; border-color:#7E00DE;  font-size:12px;">DOWNLOAD CERTIFICATE</a> --}}

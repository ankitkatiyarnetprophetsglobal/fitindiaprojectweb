...
<div class="banner_area">
            ...
            <form action="{{ route('download-event-certificate') }}" method="POST" onsubmit="return chkcaptchaval();">
                @csrf
                <div class="um-field">
                    <input type="text" name="category" id="category" value="National Sports Day 2023" disabled>
                </div> 
                            <div class="um-field">
                ...
                {{-- <a href="{{url('event-add-partcipant/'.$id)}}">Click here to upload student details to downloading student certificate</a> --}}
                </div>
                                       </div>
                                     </div>
            </form>

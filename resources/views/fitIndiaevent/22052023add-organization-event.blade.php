								...
								<div class="main_form" style="display: block;">	
											...
											<div class="um-field">
												...
												<div class="um-field-area">												
												 <select name="school_chain" id="school_chain" class="fit-pe-inputs" required>
												  <option value="">Select</option>
												  <option value="mexta">MINISTRY OF EXTERNAL AFFAIRS</option>												  
												  <option value="mhrddsel">MINISTRY OF EDUCATION (DSEL)</option>												  
												  <option value="mhrdhei">MINISTRY OF EDUCATION (HEI)</option>												  
												  <option value="mha">MINISTRY OF HOME AFFAIRS</option>												  
												  <option value="mpng">MINISTRY OF PETROLEUM AND NATURAL GAS</option>												  
												  <option value="md">MINISTRY OF DEFENCE</option>												  
												  <option value="mfinance">MINISTRY OF FINANCE</option>	
												 </select>
												 {!!$errors->first("school_chain","<span class='text-danger'>:message</span>")!!}
												</div>
											</div>								

...
<div class="container-fluid">
    ...
    <div class="base_mer ">
        <div class="base_mer_inner">
            <div class="d-flex justify-content-between align-items-center">                
                <div>
                    <h4 class="pl-4 pr-4 text-center mt-3">Branding Collaterals T-Shirt and Branding Creative</h4>
                </div>
                <div class="azadi_area d-flex">                    
                </div>                
                <div class="mt-3">
                    <div class=" mer_logo">
                        <p>Download official fit india creative</p>
                        <div class="d-flex justify-content-between align-items-center mer_mobile">
                            <a class="mer_logo_form " href="{{ url('resources/imgs/internationalwomen/merchandise/merchandisepng.zip') }}" data-icon="G">png</a>
                            <a class="mer_logo_form " href="{{ url('resources/imgs/internationalwomen/merchandise/merchandisejpg.zip') }}" data-icon="G">jpeg</a>
                            <a class="mer_logo_form " href="{{ url('resources/imgs/internationalwomen/merchandise/merchandisepdf.zip') }}" data-icon="G">pdf</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 mb-3 bm_inner">
                    <img src="{{ url('resources/imgs/internationalwomen/merchandise/merchandise.jpeg') }}" class="img-fluid shadow_m custom-img-h" title="fit india women's week" alt="fit india women's week" />
                </div>
                {{-- <div class="col-sm-12 col-md-6 col-lg-6 mb-3 bm_inner"> --}}
                <div class="col-sm-12 col-md-4 col-lg-4 mb-3 bm_inner">
                    <img src="{{ url('resources/imgs/internationalwomen/merchandise/merchandise1.jpeg') }}" class="img-fluid shadow_m custom-img-h" title="fit india women's week" alt="fit india women's week" />
                </div>
                {{-- <div class="col-sm-12 col-md-4 col-lg-4 mb-3 bm_inner">
                    <img src="{{ url('resources/imgs/internationalwomen/merchandise/merchandise2.jpeg') }}" class="img-fluid shadow_m custom-img-h" title="fit india women's week" alt="fit india women's week" />
                </div> --}}
                {{-- <div class="col-sm-12 col-md-4 col-lg-4 mb-3 bm_inner">
                ...
                <div class="mt-3">
                    <div class=" mer_logo">
                        ...
                        <div class="d-flex justify-content-between align-items-center mer_mobile">
                            ...
                            <a class="mer_logo_form " href="resources/imgs/national-sports-day-2024/t-shirt-design-front-blue.zip" data-icon="G">jpeg</a>
            ...
            <div class="row ">
                <div class="col-sm-12 col-md-6 col-lg-6 mb-3 bm_inner">
                    <img src="{{ url('resources/imgs/national-sports-day-2024/t-shirt-design-front.png') }}" class="img-fluid shadow_m " title="Fitness ki dose aadha ghanta roz" alt="Fitness ki dose aadha ghanta roz" style="max-height: 545px;" />
                </div>
                <div class="col-sm-12 col-md-6 col-lg-6 mb-3 bm_inner">
                    <img src="{{ url('resources/imgs/national-sports-day-2024/t-shirt-design-front-blue.jpeg') }}" class="img-fluid shadow_m " title="Fitness ki dose aadha ghanta roz" alt="Fitness ki dose aadha ghanta roz" style="max-height: 545px;" />
                </div>                
            </div> --}}

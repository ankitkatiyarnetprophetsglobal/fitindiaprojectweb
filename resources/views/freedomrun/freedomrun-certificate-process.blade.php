...
<div class="banner_area">
            ...
            <form action="{{ route('download-freedomrun-certificate') }}" method="POST" onsubmit="return chkcaptchaval();">
                @csrf
                <div class="um-field">
                    <input type="text" name="category" id="category" value="Fit India Swachhata Freedom Run 4.0" disabled>
                </div>
                            <div class="um-field">

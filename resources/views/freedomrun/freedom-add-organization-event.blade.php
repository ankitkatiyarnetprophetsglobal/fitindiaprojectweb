                            ...
                            */  
                            @endphp 
                                ...
                                <div class="wrap event-form">   
                                    ...
                                    <form name="freedum_run_form" method="post" action="{{route('create-freedomrun-event')}}" enctype="multipart/form-data" > 
                                            @csrf
                                ...
                                <div class="main_form" style="display: block;"> 
                                            ...
                                            <div class="um-field">
                                                    ...
                                                    <div class="um-field-area">
                                                      <!-- <label for="name">Organization / Institution / Group / School Name  *</label> -->
                                                      {{-- <input type="hidden" name="name" id="name" class="form-control" placeholder="Name" value="{{$userdata->name}}" readonly> --}}
                                            ...
                                            <div class="um-field">
                                                    ...
                                                    <div class="um-field-area">
                                                        ...
                                                        <input type="email" name="email" id="email" class="form-control" placeholder="Email" value="{{$userdata->email}}">
                                            ...
                                            <div class="multiple_image_section">
                                                <div class="um-field">
                                                    <div class="um-field-label">
                                                        <label for="eventimage1">Upload Image *</label>
                                                        <div class="um-clear"></div>
                                                    </div>
                                                    <div class="um-field-area">
                                        ...
                                        <div class="multiple_video_section">
                                            <div class="um-field">
                                                <div class="um-field-label">
                                                    <label for="eventimage1">Upload Video Link (optional)</label>
                                                    <div class="um-clear"></div>
                                                </div>
                                                <div class="um-field-area">
                                            ...
                                            <div class="um-field">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-6">
                                                        ...
                                                        <input type="date" name="from_date" class="form-control" id="from_date" value="{{ old('from_date') }}" maxlength="10" min="2023-10-02" max='2023-10-31'>
                                                        ...
                                                        <div class="col-sm-12 col-md-6">
                                                                <div class="form-group ">
                                                                    To Date
                                                                  <input type="date" name="to_date" class="form-control" id="to_date" value="{{ old('to_date') }}" maxlength="10" min="2023-10-02" max='2023-10-31'>
                                                ...
                                                <div class="row mb-3" id="event_dec" style="display:none;">
                                                    <div class="col-sm-12 col-md-12 " >
                                                        ...
                                                        <p class="m-1">E.g. The organization conducted following Fit India Swachhata Freedom Run 4.0 event:</p>
                                                        <p class="m-1">Events on 13-10-2023 with <b>50</b> participants ran for <b>3</b> Kms </p>
                                        ...
                                        <div class="d-flex just_content">
                                            ...
                                            <!-- <div class="mt-4">
                                                 <a id="invidual_download" class="btn btn-primary clic_btn btn_free" href="javascript:void(0);">Download Certificate</a>
                                                 <a id="invidual_download" class="btn btn-primary clic_btn btn_free" href="javascript:void(0);">Add Participant</a>
                                                 <a id="invidual_download" class="btn btn-primary clic_btn btn_free" href="javascript:void(0);">Edit Event</a>
                                            </div> -->
                                    <!--    </div> 
                                </div> -->

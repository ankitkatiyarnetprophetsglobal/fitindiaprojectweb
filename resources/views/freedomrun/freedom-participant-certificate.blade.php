...
<body style="padding:0;margin:0;">
  ...
  <div style="position:relative;margin:-28px; ">
    ...
    {{-- <div> --}}
      ...
      <div class="centered" style="font-family:Helvetica Nune,Helvetica; font-size:24px; font-weight:bold; position:absolute; margin-top:-400px;width:100%; text-align:center; color:blue; z-index: 10000000000000;">
        {{$participant_name}}
    {{-- </div> --}}
    </div>
  </div>

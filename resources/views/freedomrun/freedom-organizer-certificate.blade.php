...
.centered {
  ...
  <body style="padding:0;margin:0;">
      ...
      <div style="position:relative;margin:-28px; ">
        ...
        <img src="{{ asset('resources/imgs/certificate/certificate_organisers.jpg') }}"  alt="" style="width:100%;margin:0px auto; position:relative;z-index: -100; ">
        {{-- <div> --}}
          {{-- <img src="{{ $map_image}}"  alt="" style="right:4%;top:30%;width:30%;hight:50%margin:0px auto; position:absolute;z-index: 100000;"> --}}
          <div class="centered" style="font-family:Helvetica Nune,Helvetica; font-size:24px; font-weight:bold; position:absolute; margin-top:-35px;width:100%; text-align:center; color:blue; z-index: 10000000000000;">
            {{$name}}
        {{-- </div> --}}
        </div>
      </div>

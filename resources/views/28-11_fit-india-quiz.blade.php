...
<div>
        <img src="resources/imgs/fitindia_quiz_inner2_2022.jpeg" alt="Fit-india-quiz" title="Fit India Quiz 2022" class="img-fluid expand_img" />
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <p>Fit India Quiz was launched in 2021 as a part of commemorating ‘Azadi Ka Amrit Mohotsav’, it was envisaged to propagate the message of Fit India among the school children and strengthen its presence in schools, a Fit India Quiz has been envisioned to involve school children across the country. Fit India Quiz is dedicated to the school students where students with interest in sports and fitness can participate and compete at state and national level. In the first edition of Fit India Quiz, 36,299 students from 13,502 school participated and showcased their knowledge in fitness and sports. Fit India Quiz has become a popular mechanism to align the kids across the country to join the mission of fitness and adopt the fit lifestyle. Fit India Quiz comprised of preliminary rounds, state level rounds and national rounds, thus making it one of the most comprehensive and flagship quiz programs on fitness and sports in the country.</p>
                
                

            </div>
            <div class="mt-3 mb-3 ml-2 quiz_btn_fit">
			<a class="btn btn-primary btn-sm d_button b_color " href="https://fitindia.nta.ac.in/" target="_blank">Register Now</a>
                <a class="btn btn-primary btn-sm d_button " href="resources/pdf/Circular_Fi_India_Quiz_2022_Date_Extenstion.pdf" target="_blank"> <i class="fa fa-file-pdf-o" aria-hidden="true"></i>&nbsp; Download Circular</a>
                ...
                <div class="d-flex justify-content-around mail_img align-items-center ">
                    ...
                    <div>
                        <ul>
                            ...
                            <li><span><i class="fa fa-phone" aria-hidden="true"></i></span> NTA Helpline at <span>011-40759000, 011-6922 7700</span></li>
							<li><span><i class="fa fa-phone" aria-hidden="true"></i></span> SAI Call Center Number <span>1800 202 5155</span></li>

                            <li><span><i class="fa fa-envelope-o" aria-hidden="true" style="font-size:17px;"></i></span> Write to NTA at <span> fitindia[at]nta[dot]ac[dot]in</span></li>

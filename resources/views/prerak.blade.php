            ...
            <div class="row">
                  ...
                  &nbsp;&nbsp;
                   <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                      ...
                      <input type="checkbox" name="social_media_handle" vlaue="1"></p> 
                ...
                <div class="col-sm-12 col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="unique_app_id" class="form-control ft_app_id" >
                ...
                <div class="col-sm-12 col-md-12">
                 ...
                 <input type="checkbox" name="fitness_event" value="1" id="fitness_event">  <br>
...
$(document).ready(function(){
  ...
  $('#check_appid').click(function(){
    ...
    var datas = {'fitindiaid': ft_app_id}
    if(ft_app_id==""){

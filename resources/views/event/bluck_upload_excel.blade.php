            ...
            <div class="container">
                ...
                @if (Session::has('error_message'))
                    ...
                    <div class="row bulkUpload-row">
                        <div class="col-md-12">                            
                            {{-- <h4 class="mb-3">{{ $categories['name'] ?? '' }}</h4> --}}
                            <h5 class="mb-3">Suggest Outstanding Sport Talent</h5>
                            <hr/>
                    ...
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            {{-- {{ dd($event->id) }} --}}
                            <input type="hidden" class="form-control" id="id" name="id" value="{{$event->id}}" readonly > 
                            <input type="hidden" class="form-control" id="name" name="name" value="{{$event->name}}" readonly > 

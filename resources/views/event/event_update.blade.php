                                 ...
                                 @endif
                                      <form name="school_event_update" method="post" action="{{route('event-update-value')}}" enctype="multipart/form-data" > 
                                          ...
                                          <div class="main_form" style="display: block;"> 
                                              ...
                                              <div class="um-field" id="event_activity_hide" style="display:block">
                                                <div class="um-field">
                                                  <div class="um-field-label">
                                              ...
                                              <div class="um-field">
                                                ...
                                                <div class="um-field-area">                                                    
                                                    <input type="number" name="addparticipants" class="form-control" id="addparticipants" min="0" placeholder="Participants" value="{{$events->participantnum}}">
                                              ...
                                              <div class="um-field-area">	
                                                ...
                                                @php
                                                  if($events->rolewise == "cyclothon-2024"){
                                                    $role_lable = "Fit India Cyclothon";
                                                  }else{
                                                ...
                                                @endphp
                                                  ...
                                                  {{-- <select name="school_chain"  id="school_chain" class="fit-pe-inputs" required disabled>
                                                    ...
                                                    <option value="bsf" <?=(!empty($events->school_chain)&&($events->school_chain=='bsf'))? 'selected=selected' : ''?>>BSF</option>
                                                    <option value="cisf" <?=(!empty($events->school_chain)&&($events->school_chain=='cisf'))? 'selected=selected' : ''?>>CISF</option>
                                                    <option value="crpf" <?=(!empty($events->school_chain)&&($events->school_chain=='crpf'))? 'selected=selected' : ''?>>CRPF</option>
                                                    <option value="itbp" <?=(!empty($events->school_chain)&&($events->school_chain=='itbp'))? 'selected=selected' : ''?>>ITBP</option>
                                                    <option value="navy" <?=(!empty($events->school_chain)&&($events->school_chain=='navy'))? 'selected=selected' : ''?>>Navy</option>
                                                    <option value="nsg" <?=(!empty($events->school_chain)&&($events->school_chain=='nsg'))? 'selected=selected' : ''?>>NSG</option>
                                                    <option value="ssb" <?=(!empty($events->school_chain)&&($events->school_chain=='ssb'))? 'selected=selected' : ''?>>SSB</option>
                                                    <option value="corporate" <?=(!empty($events->school_chain)&&($events->school_chain=='corporate'))? 'selected=selected' : ''?>>CORPORATE</option>
                                                    <option value="group" <?=(!empty($events->school_chain)&&($events->school_chain=='group'))? 'selected=selected' : ''?>>GROUP</option>
                                                    <option value="gym" <?=(!empty($events->school_chain)&&($events->school_chain=='gym'))? 'selected=selected' : ''?>>GYM</option>
                                                    <option value="subscriber" <?=(!empty($events->school_chain)&&($events->school_chain=='subscriber'))? 'selected=selected' : ''?>>INDIVIDUAL</option>
                                                    <option value="ncc" <?=(!empty($events->school_chain)&&($events->school_chain=='ncc'))? 'selected=selected' : ''?>>NCC</option>
                                                    <option value="ngo" <?=(!empty($events->school_chain)&&($events->school_chain=='ngo'))? 'selected=selected' : ''?>>NGO</option>
                                                    <option value="nss" <?=(!empty($events->school_chain)&&($events->school_chain=='nss'))? 'selected=selected' : ''?>>NSS</option>
                                                    <option value="Nyks" <?=(!empty($events->school_chain)&&($events->school_chain=='Nyks'))? 'selected=selected' : ''?>>NYKS</option>
                                                    <option value="others" <?=(!empty($events->school_chain)&&($events->school_chain=='others'))? 'selected=selected' : ''?>>Others</option>
                                                    <option value="railways" <?=(!empty($events->school_chain)&&($events->school_chain=='railways'))? 'selected=selected' : ''?>>RAILWAYS</option>
                                              ...
                                              &nbsp;
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-6">
                                                        <div class="form-group ">
                                                          To Date
                                                          <input type="date" name="to_date" class="form-control" id="to_date" value="<?=$events->eventenddate?>" maxlength="10" min="{{$from_date}}" max="{{$to_date}}">
                                                    ...
                                                    <div class="mt-4 btn_spc">
                                                        ...
                                                        <a id="organizer_download_2_new" class="btn btn-primary clic_btn btn_free" href="{{ url('event-certificate-process', encrypt($events->id)) }}">Download Certificate</a>

...
-->
		...
		<a href="{{url('school-events')}}" class="my-events d-flex flex-row {{ (Request::is('school-events') || Request::is('school-run-update/*') || Request::is('event-uploadexcel/*') || Request::is('school-certificate-process/*') || Request::is('school-add-partcipant/*') || Request::is('school-updatedetail/*') ) ? 'active' : '' }}" style="border: 0px !important; ">

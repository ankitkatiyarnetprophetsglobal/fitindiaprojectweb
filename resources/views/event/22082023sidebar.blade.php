...
-->
		...
		{{-- <a href="{{url('school-events')}}" class="my-events d-flex flex-row {{ (Request::is('school-events') || Request::is('school-run-update/*') || Request::is('event-uploadexcel/*') || Request::is('school-certificate-process/*')) ? 'active' : '' }}" style="border: 0px !important; ">
			<span class="dashicons dashicons-list-view"></span><span>My Events</span>
		</a> --}}
		{{-- <a href="{{ url('eventspic/schoolweek-2022') }}" class="my-events d-flex flex-row {{ ($route[1] == 'eventsPicByYear') ? 'active' : '' }}">

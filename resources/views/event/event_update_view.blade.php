                            ...
                            <div class="wrap event-form"> 
                                ...
                                <form name="freedum_run_form" method="post" action="{{route('freedom-update-value')}}" enctype="multipart/form-data" > 
                                            ...
                                            <?php }  ?>
                                              ...
                                              <div class="col-sm-12 col-md-4">
                                                  <div class="form-group area_div_p">
                                                      Total Participant : <span>{{ $events->participantnum ?? 0}}</span>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <a id="organizer_download_2_new" class="btn btn-primary clic_btn btn_free"  href="{{ url('event-certificate-process', encrypt($events->id)) }}">.

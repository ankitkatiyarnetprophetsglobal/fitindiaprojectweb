...
<div class="col-sm-12 col-md-3" style="padding-top: 30px; padding-bottom:30px;  border-right: 1px solid #DCDCDC !important;">
 ...
 ?>
	...
	@endif
		...
		@if(strtolower($role) == 'school')
	    	 <a href="{{ route('schoolcert') }}" class="my-events {{ ($route[1] == 'schoolcert') ? 'active' : '' }}">
			...
			{{-- <a href="{{ route('create-school-event') }}" class="create_events d-flex flex-row {{ Request::is('create-school-event') ? 'active' : '' }}" style="border: 0px !important; "> --}}

				<a href="{{ route('create-event') }}" class="create_events d-flex flex-row {{ Request::is('create-event') ? 'active' : '' }} {{ Request::is('dashboard') ? 'active' : '' }}" style="border: 0px !important; ">
					<span class="dashicons dashicons-edit"></span><span>Organise an Event</span>
					{{-- <a href="{{ route('create-freedomrun-event') }}" class="create_events d-flex flex-row {{ Request::is('create-freedomrun-event') ? 'active' : '' }}" style="border: 0px !important; "> --}}
				{{-- <a href="{{ route('create-event') }}" class="create_events d-flex flex-row {{ Request::is('create-event') ? 'active' : '' }}" style="border: 0px !important; ">
					<span class="dashicons dashicons-edit"></span><span>Organise an Event</span> --}}
				</a>

		@else
		{{-- <a href="{{ route('create-school-event') }}" class="create_events d-flex flex-row {{ Request::is('create-school-event') ? 'active' : '' }}" style="border: 0px !important; "> --}}
			{{-- {{ dd(Request::is('create-event')) }} --}}
			<a href="{{ route('create-event') }}" class="create_events d-flex flex-row {{ Request::is('create-event') ? 'active' : '' }} {{ Request::is('dashboard') ? 'active' : '' }}" style="border: 0px !important; ">
				<span class="dashicons dashicons-edit"></span><span>Organise an Event</span>
				{{-- <a href="{{ route('create-freedomrun-event') }}" class="create_events d-flex flex-row {{ Request::is('create-freedomrun-event') ? 'active' : '' }}" style="border: 0px !important; "> --}}
			{{-- <a href="{{ route('create-event') }}" class="create_events d-flex flex-row {{ Request::is('create-event') ? 'active' : '' }}" style="border: 0px !important; ">
		...
		@if(strtolower($role) == 'mexta'
		|| strtolower($role) == 'mhrddsel'
		|| strtolower($role) == 'mhrdhei'
		|| strtolower($role) == 'mha'
		|| strtolower($role) == 'mpng'
		|| strtolower($role) == 'md'
		|| strtolower($role) == 'mfinance') --}}
...
-->
         ...
         {{-- <a href="{{ route('freedom-run-events') }}" class="my-events {{ ($route[1] == 'freedom-run-events') ? 'active' : '' }}">
			<span class="dashicons dashicons-list-view"></span>My Events
		</a>  --}}

		<a href="{{url('list-events')}}" class="my-events d-flex flex-row {{ (Request::is('list-events') || Request::is('school-run-update/*') || Request::is('event-uploadexcel/*') || Request::is('school-certificate-process/*')) ? 'active' : '' }}" style="border: 0px !important; ">
			<span class="dashicons dashicons-list-view"></span><span>My Events</span>
		</a>
		{{-- <a href="{{ route('fitindiaweek-events-pics') }}" class="my-events d-flex flex-row {{ ($route[1] == 'freedomrunEventsPics') || ($route[1] == 'eventspic') ? 'active' : '' }}" style="border:0px !important;">
			<span class="dashicons dashicons-format-gallery" ></span><span>My Event Pics</span>
		</a> --}}
		<a href="{{ route('events-pics') }}" class="my-events d-flex flex-row {{ (Request::is('events-pics') || (Request::is('events-pics'))) ? 'active' : '' }}" style="border:0px !important;">
			<span class="dashicons dashicons-format-gallery" ></span><span>My Event Pics</span>
		</a>
		{{-- {{ dd(Session::get('usermeta_role_data')); }} --}}
        @if(Auth::user()->role == 'namo-fit-india-youth-club' || Auth::user()->role == 'namo-fit-india-cycling-club' || Session::get('usermeta_role_data') == 'club')
            <a href="{{ route('download-registration-certificate') }}" class="my-events d-flex flex-row {{ (Request::is('download-registration-certificate') || (Request::is('download-registration-certificate'))) ? 'active' : '' }}" style="border:0px !important;">
                <span class="dashicons dashicons-format-gallery" ></span><span>Registration for club</span>
            </a>
        @endif
        {{-- {{ dd(Auth::user()->role); }} --}}
		<?php /*

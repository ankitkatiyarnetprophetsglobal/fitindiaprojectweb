								...
								<div class="main_form" style="display: block;">
											...
											<div class="um-field">
													...
													<div class="um-field-area">
					                                  ...
					                                  {{-- <input type="text" name="event_name" id="event_name" class="form-control" placeholder="Event Name" value="National Sports Day 2023" readonly> --}}
													  	{{-- <select name="school_chain" id="school_chain" class="fit-pe-inputs" disabled="true" required>	 --}}
														{{-- {{ dd($userdata['rolewise']) }} --}}
														@if(!$userdata['rolewise'])
														...
														@elseif($userdata['rolewise'] == 'cyclothon-2024')
														{{-- {{ dd($categories[0]['name']) }} --}}
															<select class="select_category" name="category_name" id="category_name" class="fit-pe-inputs" required>
													...
													<div class="um-field-area">
														<select name="event_activity" id="event_activity" class="fit-pe-inputs">
															...
															@foreach ($eventactivitydropdowns as $key => $value)
																<option value="{{ $value->event_activity_slug }}" >{{$value->event_activity_name}}</option>
															@endforeach
															{{-- <option value = "">Select Activity</option>
															<option value = "dance">Dance</option>
															<option value = "musical_chairs">Musical Chairs</option> --}}
														</select>
											...
											<div class="um-field">
													...
													<div class="um-field-area">
					                                  ...
					                                  <input type="text" name="org_name" id="org_name" class="form-control" placeholder="Organization / Institution / Group / School Name" value="{{$userdata->name}}" readonly>
											...
											<div class="um-field">
													...
													<div class="um-field-area">
													 	<!-- <label for="Email">Email ID *</label> -->
                                  						...
                                  						<input type="text" name="email" id="email" class="form-control" placeholder="Email" value="{{$userdata->email}}" readonly>
                                            ...
                                            <div class="um-field">
												...
												<div class="um-field-area">
													<select name="districts" id="districts" class="fit-pe-inputs" required>
                                                        {{-- disabled="true" --}}
														<option value = "">Select State</option>
														@foreach ($districts as $value)
														<option value = "{{ $value['name'] }}" <?=(!empty($value['name'])&&($value['name']== $usermeta_datadistrict))? 'selected=selected' : ''?>>{{ $value['name'] }}</option>
														{{-- <option value = "<?php //echo $value['id'],'_',$value['name']?>">{{ $value['name'] }}</option> --}}
														@endforeach
													</select>
												 	{!!$errors->first("school_chain","<span class='text-danger'>:message</span>")!!}
											...
											<div class="um-field">
												...
												@php
													if($userdata->rolewise == "cyclothon-2024"){
														$role_lable = "Fit India Cyclothon";
													}else{
														$role_lable = $userdata->rolelabel;
													}
												@endphp
												<div class="um-field-area">
										...
										<div class="addmore">
											...
											<div class="um-field">
												...
												@php
													$from_date = date('Y-m-d', strtotime($categories[0]['from_date']));
													$to_date = date('Y-m-d', strtotime($categories[0]['to_date']));
												@endphp
												<div id="all-events" class="row">
													<div class="col-sm-12 col-md-6">
														...
														<input type="date" name="from_date" class="form-control" id="from_date" value="{{ old('from_date') }}" maxlength="10" min="{{$from_date}}" max="{{$to_date}}">
														{{-- <input type="date" name="from_date" class="form-control" id="from_date" value="{{ old('from_date') }}" maxlength="10" min="2024-07-01" max="2024-07-31"> --}}
														...
														<div class="col-sm-12 col-md-6">
																<div class="form-group ">
																  ...
																  <input type="date" name="to_date" class="form-control" id="to_date" value="{{ old('to_date') }}" maxlength="10" min="{{$from_date}}" max="{{$to_date}}">

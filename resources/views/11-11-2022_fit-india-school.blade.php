        ...
        <div class="row " >
            <div class="col-sm-12 col-md-8 col-lg-9" >
                <p>{{ __('sentence.Honble_Prime_Minister_of_India_has_launched_the_Fit_India_Movement_on_29_Aug_2019_with_a_view_to_make_Physical_Fitness_a_way_of_life')}}
                   ...
                   {{ __('sentence.Fit_India_would_be_a_success_only_when_it_becomes_a_peoples_movement_We_have_to_play_the_role_of_a_catalyst')}}
                ...
                <p>{{ __('sentence.How_to_Live_ought_to_be_the_first_pillar_of_formal_education_This_involves_teaching_and_practicing_the_art_of_taking_care_of_ones_body_and_health_daily_Schools_have_to_be_the_first_formal_institution_after_home_where_physical_fitness_is_taught_and_practiced')}}
                ...
                <p>
					{{ __('sentence.In_the_above_background_the_Fit_India_Mission_encourages_Schools_to_Organise_a')}}
					<strong>{{ __('sentence.FitIndia_SchoolWeek')}}</strong>
					{{ __('sentence.in_month_of_November_December_It_has_also_prepared_a_set_of')}}
					<strong>{{ __('sentence.Fit_India_School_Certification')}}</strong>
					{{ __('sentence.with_simple_and_easy_parameters')}}

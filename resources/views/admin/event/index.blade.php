        ...
        <div class="row">
          <div class="col-md-12">		  
		   <div class="card">		   
			  ...
			  <div class="col-md-2">
			  @if(($admins_role == '3'))
			  <button class="btn btn-success btn-sm dwl" name="download" value="download" onclick="window.location.href='event_export?ename={{ request()->input('event_name')}}&st={{ $stateadmin }}&dst={{ request()->input('district')}}&dbk={{ request()->input('block')}}&cat={{ request()->input('category')}}&dat={{ request()->input('month')}}&search=search';">
			  <i class="fa fa-download"></i> Download</button>
			  @else
			  <button class="btn btn-success btn-sm dwl" name="download" value="download" onclick="window.location.href='event_export?ename={{ request()->input('event_name')}}&st={{ request()->input('state')}}&dst={{ request()->input('district')}}&dbk={{ request()->input('block')}}&cat={{ request()->input('category')}}&dat={{ request()->input('month')}}&search=search';">
			  <i class="fa fa-download"></i> Download</button>
			  @endif
			  </div>
			  <div class="col-md-10">

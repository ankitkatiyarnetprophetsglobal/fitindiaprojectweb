        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
				{{-- @if($admins_role, array(8))
				{{ dd("asdfasdfasdfasdfasdfasdfasdfasdfasdfasdf") }}
				@endif --}}
				{{-- {{ dd("987") }}			 --}}
				...
				@if(!in_array($admins_role, array(4,7,8,9)))
					<li class="nav-item">
				...
				@if(!in_array($admins_role, array(2,3,4,6,8,9)))
					<li class="nav-item">
				...
				@if(!in_array($admins_role, array(2,3,6,7,8,9)))
					<li class="nav-item">
				...
				@if(!in_array($admins_role, array(2,3,4,6,7)))
					<li class="nav-item @if(($routename =='admin.posts.index')||($routename =='admin.category.index')) {{ 'menu-is-opening menu-open' }} @endif">
						...
						<ul class="nav nav-treeview">
							...
							@if(!in_array($admins_role, array(2,3,4,6,7,8)))
								<li class="nav-item">

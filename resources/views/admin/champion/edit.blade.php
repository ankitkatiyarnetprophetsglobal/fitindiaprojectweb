...
@section('title', 'Fit India Admin-Edit Champions')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Update Champions</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
              <li class="breadcrumb-item active">Update Champions</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
     ...
     @csrf
         ...
         <div class="um-field">
           <h2 for="ambassador_name"> FitIndia Ambassador</h2>
                        ...
                        <div class="um-field">
                            <div class="um-field-label">
                              <label for="description">Why Do You Want to beacome a fitindia champion Describe</label>
                              <div class="um-clear"></div>
                            </div>
                            <div class="um-field-area">
                            <textarea
                               id="description" type="text" name="description" value="" rows="10" cols="45">
                        ...
                        <div class="um-field">
                            <div class="um-field-area">
                              <input type="submit" name="champion-create" value="Submit">
                            </div>
                        </div>    

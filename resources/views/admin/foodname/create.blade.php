          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Foodnames</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{ route('admin.foodnames.store') }}" >
			    @csrf
                <div class="card-body">
                @if (session('status'))
                ...
                @endif
                    ...
                    <input type="text" name="foodname" class="form-control" id="foodname" placeholder="Enter Food names">

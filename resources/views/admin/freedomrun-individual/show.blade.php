                        ...
                        <li class="li_Flex">
                          ...
                          <div>@if(!empty($events->catname)) {{$events->catname}} @endif</div>
                           ...
                           <li class="li_Flex">
                            ...
                            <div>@if(!empty($events->email)) {{$events->email}} @endif </div>
                          </li>
                            ...
                            <div>@if(!empty($events->mobile)) {{$events->mobile}} @endif </div>
                           </li>
                            

                        <li class="li_Flex">
                          <div><strong>Kilometer Run:</strong></div>
                          <div>@if(!empty($events->kmrun)) {{$events->kmrun}} @endif  </div>
                       </li>

                        <li class="li_Flex">
                          <div><strong>Event Start Date:</strong></div>
                          <div> @if(!empty($events->eventstartdate)) {{$events->eventstartdate}} @endif    </div>
                       </li>
                        <li class="li_Flex">
                          <div><strong>Event End Date:</strong></div>
                          <div> @if(!empty($events->eventenddate)) {{$events->eventenddate}} @endif </div>
                       </li>
                        <li class="li_Flex">
                          <div><strong>No of Participant:</strong></div>
                          <div> @if(!empty($events->participantnum)){{$events->participantnum}} @endif </div>
                       </li>
                        <li class="li_Flex">
                          <div><strong>Event Organiser Name:</strong></div>
                          <div>@if(!empty($events->organiser_name)){{$events->organiser_name}} @endif   </div>
                       </li>

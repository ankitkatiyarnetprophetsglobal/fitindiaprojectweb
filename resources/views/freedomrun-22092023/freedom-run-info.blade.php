...
<div>
   <!-- <img src="resources/imgs/freedomrun-3.jpeg" alt="freedom-run-info" title="freedom-run-info" class="img-fluid expand_img" /> -->
	<img src="resources/imgs/Unity-innr-bnr.jpg" alt="freedom-run-info" title="freedom-run-info" class="img-fluid expand_img" />
</div>
        ...
        <div class="row row_reverse">
            ...
            <div class="col-sm-12 col-md-8 col-lg-8">
                ...
                <div class="webview">
                    ...
                    <h1 class="head_free_run">Fit India Freedom Run 3.0</h1>
                    <!-- <div class="under_line"></div> -->
                    <div class="ahover">
                        <a href="register" class="og_btn" target="_blank">Register as an Organizer</a>
                        <a href="resources/pdf/SOP-Freedom-Run-3.0.pdf" class="og_btn" target="_blank" style="background-color:#45a164; padding-left: 42px;padding-right:42px;">Steps to Register
                        </a>
						<a href="resources/pdf/freedom-run-hoarding-2022.pdf" class="og_btn" target="_blank">Download Event Creatives</a>
                        <div class="m-40"></div>
                    </div>
                </div>
                ...
                <p class="text-justify pr-3">Fit India Mission in its endeavour to promote fitness and creating awareness amongst countrymen keeps coming with innovating fitness campaigns to indulge people in fitness activities. Fit India Mission converges with Swachh Bharat Abhiyan with Fit India Plog Run where fitness meets Swatchhta in a form of engaging fun-loving exercise is now entailed in Fit India Freedom Run culminating where we discover a litter free clean surroundings while running. </p>
                 ...
                 <h5 class="text-center mt-3 mb-3">  2nd October | 2 Kms | Fit India Plog Run</h5>
					...
					<p class="text-justify">
						Till date two editions of the campaign have been held in 2020 and 2021 respectively and the campaign has seen tremendous support from various stakeholders such as government, private organizations and individuals from all walks of life and demographics making it a truly people’s campaign.
                ...
                <!-- <p>Fit India Freedom Run to culminate on Gandhi Jayanti, 2nd October, with nationwide Fit India Plog Run.</p>  -->
                <p><b>Promote Fit India Freedom Run 3.0 on your social media channels by using <span style="color: #fcac39;font-size:16px;">#</span><span style="color: #f8162c;font-size:16px;">Azadi</span><span style="color: #000;font-size:16px;">Ka</span><span style="color: #1681f8;font-size:16px;">AmritMahotsav</span> & <span style="color: #fcac39;font-size:16px;">#</span><span style="color: #f8162c;font-size:16px;">Run</span><span style="color: #000;font-size:16px;">4</span><span style="color: #1681f8;font-size:16px;">India</span></b></p>
                <div>
                    ...
                    <ul>
                        ...
                        <li>Create an event on Fit India Portal either as an individual or as an organiser as per your eligibility for any number of day(s) starting from 2nd October till 31st October</li>
                        ...
                        <div class="main_form">
                            ...
                            <div class="um-field">
                                ...
                                <div class="um-field-area">
                                    ...
                                    <input type="text" name="event_name" id="event_name" class="form-control" placeholder="Event Name" value="Fit India Freedom Run 3.0" readonly>
                                </div>
                            </div>
                            <div class="um-field"></div>
							<div class="um-field">
                            ...
                            <div class="um-field">
                                ...
                                <div class="um-field-area">
                                    <div class="event-row-lt event-row-it-resp mt-2 ">
                                        ...
                                        <input type="date" name="from_date" class="form-control" id="from_date" maxlength="10" value="{{ old('from_date') }}" min="2022-10-02" max='2022-10-31'>
                                    ...
                                    <div class="event-row-lt event-row-it-resp mt-2" id="eventenddatediv">
                                        To Date
                                        <input type="date" name="to_date" class="form-control" id="to_date" maxlength="10" value="{{ old('to_date') }}"  min="2022-10-02" max='2022-10-31'>
                ...
                <a class="getlink" href="javascript:void(0);" data-link="<?= $web_link ?>" style="<?= $pointer_false ?>">
                    <div class="card_partner shadow1">
                        ...
                        <div class="card_partner_inner">
                            ...
                            <!-- <h6 class="weblink_area"><span>Website Link</span>&nbsp; <b><a href="" style="color: #1da1f2;;font-weight:600">http://103.65.20.170/fitind/freedom-run-2.0</a> </b></h6> -->
                        </div>
                    </div>
                </a>
            </div>

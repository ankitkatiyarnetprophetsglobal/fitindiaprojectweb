                                              ...
                                              <div class="row">
                                                  <div class="col-sm-12 col-md-6">
                                                      <div class="form-group ">
                                                          ...
                                                          <input type="date" name="from_date" class="form-control" id="from_date" value="<?=$events->eventstartdate?>" maxlength="10" min="2022-09-02" max='2022-10-31' readonly>
                                                  ...
                                                  <div class="col-sm-12 col-md-6">
                                                      <div class="form-group ">
                                                        To Date
                                                        <input type="date" name="to_date" class="form-control" id="to_date" value="<?=$events->eventenddate?>" maxlength="10" min="2022-09-02" max='2022-10-31' readonly>

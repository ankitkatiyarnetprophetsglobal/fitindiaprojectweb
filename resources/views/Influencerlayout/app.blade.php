...
<!-- <div class="modal fade" id="videoId" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="videoIddropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-xl modal-sm">
    <div class="modal-content">
      <div class="modal-header" style="padding: .275rem 1rem;">
      ...
      <div class="modal-body">
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="embed-responsive-item" src="resources/videos/Anthem_29th_June.mp4" allowfullscreen></iframe>
        </div>
      </div>

...
<p style="font-size: 30px; font-weight: 600; border-bottom: 1px solid #FF9946; padding-bottom:10px; width: 70%; margin: 0 auto 20px;"><?php print_r(strtoupper($participant)); ?> </p>

    ...
    <div class="base_mer " style="background:#f7f7f7;">
        ...
        <div class="row align-items-center justify-content-center my-5">
            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                <div class="image_holder">
                    <span class="image_section">
                        <img src="{{ url('resources/imgs/event2023/nsdschoolbackdrop.jpg') }}" />
                    </span>
    
                    <span class="img_txt_section">
                        <a href="resources/imgs/event2023/nsdschoolbackdrop.ai" class="btn btn-primary btn-sm" data-icon="G">Download Backdrop</a>
                    </span>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                <div class="image_holder">
                    <span class="image_section">
                        <img src="{{ url('resources/imgs/event2023/nsdschoolstandee.jpg') }}" />
                    </span>
    
                    <span class="img_txt_section">
                        <a href="resources/imgs/event2023/nsdschoolstandee.ai" class="btn btn-primary btn-sm" data-icon="G">Download Standee</a>
                    </span>
                </div>
            </div>
        </div>

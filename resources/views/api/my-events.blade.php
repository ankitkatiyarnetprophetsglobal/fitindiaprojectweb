            ...
            <div class="row ">
                <div class="col-sm-12 col-md-3 ">
                    <div class="events-sidebar">									
                        ...
                        <a href="my-events.html" class="my-events active "><span class="dashicons dashicons-list-view"></span>My Events</a>
                ...
                <div class="col-sm-12 col-md-9 ">
                    <div class="event-form my-event">
                        ...
                        <div class="um-field">
                                <h2 for="event_name">My Events</h2>
                                
                        </div>
                        <div class="all-events">
        <div class="no-events">You do not have added any Event. Do you want to organise an Event? please <a href="create-event" style="color:#FF9933;">Click</a></div>		</div>
            </div>
                </div>
            </div>

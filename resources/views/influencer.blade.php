...
.freeHead_o {
    ...
    <div class="row">
            <div class="col-sm-12 col-md-12 ">
				   ...
				   <a href="" class="btn  n_btn btn_round o_bg btn_width btn_hover_eff prerak_btn">Prerak</a>
            ...
            <div class="card">
                <div class="card-head" id="headingOne">
                    <h2 class="mb-0 collapsed" data-toggle="collapse" data-target="#collapseFISW1" aria-expanded="false"
                        aria-controls="collapseOne" style="color:#0bb078;font-weight: 200; font-size: 16px;">
            ...
            <div class="card">
                <div class="card-head" id="headingTwo">
                    <h2 class="mb-0 collapsed" data-toggle="collapse" data-target="#collapseFISW2" aria-expanded="false"
                        aria-controls="collapseTwo" style="color:#119ff1;font-weight: 200;font-size: 16px;">   Fit India Ambassador (Level 2) 
                    </h2>
                </div>
            ...
            <div class="card">
                <div class="card-head" id="headingThree">
                    <h2 class="mb-0 collapsed" data-toggle="collapse" data-target="#collapseFISW3" aria-expanded="false"
                        aria-controls="collapseThree" style="color:#f06f11;font-weight: 200; font-size: 16px;">Fit India Prerak (Level 1)
                    </h2>
                </div>
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row"> 
                            <div class="col-sm-12 col-md-12 col-lg-12 mt-3">
                               <h6 class="g_bg b-radius sk_btn g_bg_btn f_size r_shape mt-3">Fit India Prerak (Social media specialist)</h6><br><br>

...
<div class="role-row">
                         <input type="radio" name="roletype" checked="" value="1" onclick="fi_rolechange(this.value)"> Ministries/Departments<input type="radio" name="roletype" value="2" onclick="fi_rolechange(this.value)"> Armed forces/CPF <input type="radio" name="roletype" value="0"  onclick="fi_rolechange(this.value)"> Other   </div>
                   <!-- <div class="role-row">
                ...
                <div class="register-row"> 
                    ...
                    <div class="register-row-rt">                        
						<input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="off" placeholder="Mobile">
							@error('phone')
								<span class="invalid-feedback" role="alert">
									<strong>{{ $message }}</strong>
								</span>

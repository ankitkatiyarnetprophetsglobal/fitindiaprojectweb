                          ...
                          <select class="form-control @error('role') is-invalid @enderror" name="role" id="role" required autocomplete="role" autofocus>
                            ...
                            @endforeach
                                ...
                                <select name="" id="" class="form-control">
                                    ...
                                    <option value="">Cyclopaths</option>
                                    <option value="">Borivali cycle club</option>
                                    <option value="">Amit Kumar Jha</option>
                                    <option value="">Dr Chirag Parmar</option>
                                    <option value="">Baselious public school</option>
                                </select>
                    </div>
                    <div class="register-row-rt">
                    </div>

  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-12 signup_frm">
         ...
         <div class="">
            <form id="fi-register" class="register-form" action="{{ route('saveregisterdrive') }}" method="post" novalidate="novalidate">
                @csrf
                @if (Session::has('succ'))
            ...
            @endif
                ...
                <div class="register-row">
                    <div class="register-row-lft">
                        ...
                        <option value="chennai-cycle-drive">Chennai cycle drive</option>
                        </select>
                        @error('role')
...
<script type="text/javascript">
        ...
        $('.cyclothonrolew').change(function(){
            ...
            if(cyclothon_val == 'individual'){
                ...
                htmlroleclub = ``;
                htmlroleclub += `<option value="cyclothon-2024">Namo Fit India Club For Cycling</option>`
                // htmlroleclub += `<option value="cyclothon-2024">FIT INDIA CYCLING DRIVE 1</option>`
                // htmlroleclub += `<option value="namo-fit-india-cycling-club">NAMO FIT INDIA CYCLING CLUB</option>`
                // htmlroleclub += `<option value="namo-fit-india-youth-club">NAMO FIT INDIA YOUTH CLUB</option>`

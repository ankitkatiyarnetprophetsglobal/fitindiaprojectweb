    ...
    <div class="banner_area">
            ...
            <div class="container">
                ...
                <div class="container" id="{{ $active_section_id }}">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="mb-4"><strong>Add Participants *</strong></h2>
                                    @if (session('success'))
                                        <div class="alert alert-success">
                                            {{ session('success') }}
                                        </div>
                                    @endif
                <form action="{{ url('school-update-partcipant') }}" method="POST">
                    @csrf
                    ...
                    <input type="hidden" name="id" value="{{ encrypt($event->id) }}">
                       ...
                       <!--  <h2><strong>Add Participants *</strong></h2> -->
                        ...
                        <div class="form-group">
                            ...
                            <label for="userEmail"><b>Participant Name(s)*</b> <i style="color: blue;">(Please enter one name in one row)</i>
                            </label>
							...
							if(!empty($event->participant_names)){
								foreach(unserialize($event->participant_names) as $name){
									echo trim(ucfirst(str_replace("PHP_EOL","<br>",strip_tags(strip_tags($name)))));
									echo "\n";
									}
							} ?></textarea>

                      ...
                      <div class="row ">
                          ...
                          <div class="col-sm-12 col-md-9 school_update">
                              <div class="description_box">
                                 ...
                                 @endif
                                      <form name="school_event_update" method="post" action="{{route('school-update-value')}}" enctype="multipart/form-data" > 
                                          @csrf
                                          <input type="hidden" name="id" value="{{encrypt($events->id)}}"/>
                                          ...
                                          <div class="main_form" style="display: block;"> 
                                              ...
                                              <div class="um-field">
                                                  ...
                                                  <div class="um-field-area">
                                                      <input type="text" name="event_name" id="event_name" class="form-control" placeholder="Event Name" value="Fit India Week 2023" readonly>
                                                  </div>
                                              </div>
                                              <div class="um-field"></div>
                                              <div class="um-field">
                        ...
                        ?>  
                                              ...
                                              <div class="multiple_video_section">
                                                  ...
                                                  if(!empty($video_link_arr)){ 
                                                    $i=1; 
                                                    foreach($video_link_arr as $key=>$video_link_value){ 
                                                  ?>
                                                  <div class="um-field">
                                                      <div class="um-field-label">
                                                      ...
                                                      <div class="um-field-area">
                                                          <input type="url" name="video_link[<?=$key?>]" class="form-control" placeholder="Video Link" value="<?= strip_tags($video_link_value)?>">     
                                              ...
                                              <div class="row">
                                                  <div class="col-sm-12 col-md-6">
                                                      <div class="form-group ">
                                                          ...
                                                          <input type="date" name="from_date" class="form-control" id="from_date" value="<?=$events->eventstartdate?>" maxlength="10" min="2023-11-15" max='2024-01-31' >
                                                  ...
                                                  <div class="col-sm-12 col-md-6">
                                                      <div class="form-group ">
                                                        To Date
                                                        <input type="date" name="to_date" class="form-control" id="to_date" value="<?=$events->eventenddate?>" maxlength="10" min="2023-11-15" max='2024-01-31'>
                                          ...
                                          <div class="mt-4 btn_spc">
                                              @php
                                                $encryptedid = encrypt($events->id);
                                              @endphp
                                              <a id="organizer_download_1" class="btn btn-primary clic_btn btn_free" style="display:none" href="javascript:void(0);" onclick="return alert('Please fill all the participant details')" >
                                                Download Certificate
                                              </a> 
                                              <a id="organizer_download_2" class="btn btn-primary clic_btn btn_free" style="display:none" href="{{url('freedom-certificate-process')}}/{{$encryptedid}}">
                                                Download Certificate
                                              </a>
                                              <a id="organizer_download_2_new" class="btn btn-primary clic_btn btn_free" href="{{ url('school-certificate-process', $encryptedid) }}">
                                                Download Certificate
                                              </a>
                                              <a id="invidual_download" class="btn btn-primary clic_btn btn_free" href="{{url('school-add-partcipant/'.$encryptedid)}}">

                                    ...
                                    <div class="main_form" style="display: block;"> 
                                        ...
                                        <div class="um-field">
                                                ...
                                                <div class="um-field-area">
                                                    <input type="text" name="event_name" id="event_name" class="form-control" placeholder="Event Name" value="Fit India Week 2022" readonly>
                                                </div>
                                        </div>
                                        ...
                                        <div class="um-field">
                                                ...
                                                <div class="um-field-area">
                                                    <input type="number" name="contact" class="form-control" id="contact" placeholder="Contact" value="{{$events->contact}}" maxlength="10" readonly>
                                        ...
                                        <div class="multiple_video_section">
                                                ...
                                                <div class="um-field">
                                                    ...
                                                    <div class="um-field-area">
                                                        <input type="text" name="video_link[<?=$key?>]" class="form-control" value="<?=strip_tags($video_link_value)?>" readonly>     
                                                    </div>
                                                </div>
                                                <?php $i++;} } ?>
                                        </div>
                                        ...
                                        <div class="row">
                                                <div class="col-sm-12 col-md-6">
                                                    ...
                                                    <input type="date" name="from_date" class="form-control" id="from_date" value="<?=$events->eventstartdate?>" maxlength="10" min='2022-11-15' max='2023-01-31' readonly>
                                                ...
                                                <div class="col-sm-12 col-md-6">
                                                    <div class="form-group ">
                                                        To Date
                                                        <input type="date" name="to_date" class="form-control" id="to_date" value="<?=$events->eventenddate?>" maxlength="10" min='2022-11-15' max='2023-01-31' readonly>

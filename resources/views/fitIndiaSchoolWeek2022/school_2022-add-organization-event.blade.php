							...
							@endphp	
								...
								<div class="wrap event-form">	
                                 ...
                                 @endif
									...
									<form name="freedum_run_form" method="post" action="{{route('create-school-event-post')}}" enctype="multipart/form-data" > 
											@csrf
								...
								<div class="main_form" style="display: block;">	
											...
											<div class="um-field">
													...
													<div class="um-field-area">
						                                  ...
						                                  {{-- <input type="number" name="contact" class="form-control" id="contact" placeholder="Contact" value="{{$events->contact ?? $userdata->phone}}" maxlength="10"> --}}
											...
											<div class="um-field">
												...
												<div class="row">
													<div class="col-sm-12 col-md-6">
														...
														<input type="date" name="from_date" class="form-control" id="from_date" value="{{ old('from_date') }}" maxlength="10" min="2023-11-15" max='2024-01-31'>
														...
														<div class="col-sm-12 col-md-6">
																<div class="form-group ">
																	To Date
																  <input type="date" name="to_date" class="form-control" id="to_date" value="{{ old('to_date') }}" maxlength="10" min="2023-11-15" max='2024-01-31'>
												...
												<div class="row mb-3" id="event_dec" style="display:none;">
													<div class="col-sm-12 col-md-12 " >
														...
														<p class="m-1">Events on 13-10-2022 with <b>50</b> participants ran for <b>3</b> Kms </p>
										...
										<div class="d-flex just_content">
											...
											<div class="um-field cr_event">
													<div class="um-field-area d_btny">
														<a download="fit_India_logo.jpg" href="{{url('resources/pdf/fit_India_logo.jpg')}}" >Download Fit India Logo</a>
													</div>
											</div>
										</div>
											<!-- <div class="mt-4">

                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-end">
                                <div class="custonFileUpload">
                                    ...
                                    <input type="file" class="form-control " name="ex_file_sheet" accept =".xlsx">
                                    </div>
                                    <button type="submit" class="btn btn-blue" style="height:40px; border-radius:4px">Submit</button>
                            </div>
                             @error('ex_file_sheet')

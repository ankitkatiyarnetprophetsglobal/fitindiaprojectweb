...
<div class="banner_area">
            ...
            <form action="{{ route('download-school-certificate') }}" method="POST" onsubmit="return chkcaptchaval();">
                @csrf
                <div class="um-field">
                    <input type="text" name="category" id="category" value="Fit India Week 2023" disabled>
                </div> 
                            <div class="um-field">
                ...
                @endphp
                <a href="{{url('school-add-partcipant/'.$encryptedid)}}">Click here to upload student details to downloading student certificate</a>
                </div>
                                       </div>
                                     </div>
            </form>

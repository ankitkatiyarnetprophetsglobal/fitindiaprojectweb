            ...
            <div class="col-12">
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-item active">
						...
						<div class="carousel-item active">
                            <a href="https://fitindia.gov.in/freedom-run-3.0" >
                                <!--<img src="resources/imgs/freedomrun-3.jpeg" class="d-block w-100" alt="freedom-run-3.0" title="NATIONAL SPORTS DAY 2022"> -->
								<img src="resources/imgs/Unity-home-bnr.jpg" class="d-block w-100" alt="freedom-run-3.0" title="freedom-run-3.0"> 
                            </a>
                        </div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="resources/imgs/emailer/web_popup_qr.jpg" class="img-fluid" />
            </div>

    ...
    <div class="container" >
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <h2><center>Sports Goods Manufacturers Conclave Registration Form</center></h2>
            ...
            {{-- <div class="backBtn">
                ...
                @endif
                <form action="{{ route('save-conclave-registration') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    {{-- <div class="role-row">
